...
def Handle_Dico_DictionaryOfInteger_DownCast(AnObject):
...
def Handle_Dico_DictionaryOfTransient_DownCast(AnObject):
...
def Handle_Dico_StackItemOfDictionaryOfInteger_DownCast(AnObject):
...
def Handle_Dico_StackItemOfDictionaryOfTransient_DownCast(AnObject):
