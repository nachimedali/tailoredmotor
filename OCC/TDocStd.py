...
def Handle_TDocStd_Application_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_Application_DownCast(AnObject)
...
def Handle_TDocStd_ApplicationDelta_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_ApplicationDelta_DownCast(AnObject)
...
def Handle_TDocStd_CompoundDelta_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_CompoundDelta_DownCast(AnObject)
...
def Handle_TDocStd_DataMapNodeOfLabelIDMapDataMap_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_DataMapNodeOfLabelIDMapDataMap_DownCast(AnObject)
...
def Handle_TDocStd_Document_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_Document_DownCast(AnObject)
...
def Handle_TDocStd_Modified_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_Modified_DownCast(AnObject)
...
def Handle_TDocStd_MultiTransactionManager_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_MultiTransactionManager_DownCast(AnObject)
...
def Handle_TDocStd_Owner_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_Owner_DownCast(AnObject)
...
def Handle_TDocStd_SequenceNodeOfSequenceOfApplicationDelta_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_SequenceNodeOfSequenceOfApplicationDelta_DownCast(AnObject)
...
def Handle_TDocStd_SequenceNodeOfSequenceOfDocument_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_SequenceNodeOfSequenceOfDocument_DownCast(AnObject)
...
def Handle_TDocStd_XLink_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_XLink_DownCast(AnObject)
...
def Handle_TDocStd_XLinkRoot_DownCast(AnObject):
    return _TDocStd.Handle_TDocStd_XLinkRoot_DownCast(AnObject)
