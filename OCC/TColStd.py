...
def Handle_TColStd_DataMapNodeOfDataMapOfAsciiStringInteger_DownCast(AnObject):
...
def Handle_TColStd_DataMapNodeOfDataMapOfIntegerInteger_DownCast(AnObject):
...
def Handle_TColStd_DataMapNodeOfDataMapOfIntegerListOfInteger_DownCast(AnObject):
...
def Handle_TColStd_DataMapNodeOfDataMapOfIntegerReal_DownCast(AnObject):
...
def Handle_TColStd_DataMapNodeOfDataMapOfIntegerTransient_DownCast(AnObject):
...
def Handle_TColStd_DataMapNodeOfDataMapOfStringInteger_DownCast(AnObject):
...
def Handle_TColStd_DataMapNodeOfDataMapOfTransientTransient_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfAsciiString_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfBoolean_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfByte_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfCharacter_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfExtendedString_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfInteger_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfListOfInteger_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfReal_DownCast(AnObject):
...
def Handle_TColStd_HArray1OfTransient_DownCast(AnObject):
...
def Handle_TColStd_HArray2OfBoolean_DownCast(AnObject):
...
def Handle_TColStd_HArray2OfCharacter_DownCast(AnObject):
...
def Handle_TColStd_HArray2OfInteger_DownCast(AnObject):
...
def Handle_TColStd_HArray2OfReal_DownCast(AnObject):
...
def Handle_TColStd_HArray2OfTransient_DownCast(AnObject):
...
def Handle_TColStd_HPackedMapOfInteger_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfAsciiString_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfExtendedString_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfHAsciiString_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfHExtendedString_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfInteger_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfReal_DownCast(AnObject):
...
def Handle_TColStd_HSequenceOfTransient_DownCast(AnObject):
...
def Handle_TColStd_HSetOfInteger_DownCast(AnObject):
    return _TColStd.Handle_TColStd_HSetOfInteger_DownCast(AnObject)
...
def Handle_TColStd_HSetOfReal_DownCast(AnObject):
    return _TColStd.Handle_TColStd_HSetOfReal_DownCast(AnObject)
...
def Handle_TColStd_HSetOfTransient_DownCast(AnObject):
    return _TColStd.Handle_TColStd_HSetOfTransient_DownCast(AnObject)
...
def Handle_TColStd_IndexedDataMapNodeOfIndexedDataMapOfTransientTransient_DownCast(AnObject):
...
def Handle_TColStd_IndexedMapNodeOfIndexedMapOfInteger_DownCast(AnObject):
...
def Handle_TColStd_IndexedMapNodeOfIndexedMapOfReal_DownCast(AnObject):
...
def Handle_TColStd_IndexedMapNodeOfIndexedMapOfTransient_DownCast(AnObject):
...
class TColStd_ListIteratorOfSetListOfSetOfInteger(object):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_ListIteratorOfSetListOfSetOfInteger_SetValue(self, value)
...
class TColStd_ListIteratorOfSetListOfSetOfReal(object):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_ListIteratorOfSetListOfSetOfReal_SetValue(self, value)
...
def Handle_TColStd_ListNodeOfListOfAsciiString_DownCast(AnObject):
...
def Handle_TColStd_ListNodeOfListOfInteger_DownCast(AnObject):
...
def Handle_TColStd_ListNodeOfListOfReal_DownCast(AnObject):
...
def Handle_TColStd_ListNodeOfListOfTransient_DownCast(AnObject):
...
class TColStd_ListNodeOfSetListOfSetOfInteger(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_ListNodeOfSetListOfSetOfInteger_SetValue(self, value)
...
def Handle_TColStd_ListNodeOfSetListOfSetOfInteger_DownCast(AnObject):
    return _TColStd.Handle_TColStd_ListNodeOfSetListOfSetOfInteger_DownCast(AnObject)
...
class TColStd_ListNodeOfSetListOfSetOfReal(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_ListNodeOfSetListOfSetOfReal_SetValue(self, value)
...
def Handle_TColStd_ListNodeOfSetListOfSetOfReal_DownCast(AnObject):
    return _TColStd.Handle_TColStd_ListNodeOfSetListOfSetOfReal_DownCast(AnObject)
...
def Handle_TColStd_ListNodeOfSetListOfSetOfTransient_DownCast(AnObject):
    return _TColStd.Handle_TColStd_ListNodeOfSetListOfSetOfTransient_DownCast(AnObject)
...
class TColStd_QueueNodeOfQueueOfInteger(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_QueueNodeOfQueueOfInteger_SetValue(self, value)
...
def Handle_TColStd_QueueNodeOfQueueOfInteger_DownCast(AnObject):
    return _TColStd.Handle_TColStd_QueueNodeOfQueueOfInteger_DownCast(AnObject)
...
class TColStd_QueueNodeOfQueueOfReal(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_QueueNodeOfQueueOfReal_SetValue(self, value)
...
def Handle_TColStd_QueueNodeOfQueueOfReal_DownCast(AnObject):
    return _TColStd.Handle_TColStd_QueueNodeOfQueueOfReal_DownCast(AnObject)
...
def Handle_TColStd_QueueNodeOfQueueOfTransient_DownCast(AnObject):
    return _TColStd.Handle_TColStd_QueueNodeOfQueueOfTransient_DownCast(AnObject)
...
class TColStd_QueueOfInteger(object):
    ...
    def SetChangeFront(self, value):
        """SetChangeFront(TColStd_QueueOfInteger self, Standard_Integer value)"""
        return _TColStd.TColStd_QueueOfInteger_SetChangeFront(self, value)
...
class TColStd_QueueOfReal(object):
    ...
    def SetChangeFront(self, value):
        ...
        return _TColStd.TColStd_QueueOfReal_SetChangeFront(self, value)
...
def Handle_TColStd_SequenceNodeOfSequenceOfAddress_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfAsciiString_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfBoolean_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfExtendedString_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfHAsciiString_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfHExtendedString_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfInteger_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfReal_DownCast(AnObject):
...
def Handle_TColStd_SequenceNodeOfSequenceOfTransient_DownCast(AnObject):
...
class TColStd_SetListOfSetOfInteger(object):
    ...
    def SetFirst(self, value):
        ...
        return _TColStd.TColStd_SetListOfSetOfInteger_SetFirst(self, value)
    ...
    def SetLast(self, value):
        ...
        return _TColStd.TColStd_SetListOfSetOfInteger_SetLast(self, value)
...
class TColStd_SetListOfSetOfReal(object):
    ...
    def SetFirst(self, value):
        ...
        return _TColStd.TColStd_SetListOfSetOfReal_SetFirst(self, value)
    ...
    def SetLast(self, value):
        ...
        return _TColStd.TColStd_SetListOfSetOfReal_SetLast(self, value)
...
class TColStd_StackNodeOfStackOfInteger(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_StackNodeOfStackOfInteger_SetValue(self, value)
...
def Handle_TColStd_StackNodeOfStackOfInteger_DownCast(AnObject):
    return _TColStd.Handle_TColStd_StackNodeOfStackOfInteger_DownCast(AnObject)
...
class TColStd_StackNodeOfStackOfReal(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TColStd.TColStd_StackNodeOfStackOfReal_SetValue(self, value)
...
def Handle_TColStd_StackNodeOfStackOfReal_DownCast(AnObject):
    return _TColStd.Handle_TColStd_StackNodeOfStackOfReal_DownCast(AnObject)
...
def Handle_TColStd_StackNodeOfStackOfTransient_DownCast(AnObject):
    return _TColStd.Handle_TColStd_StackNodeOfStackOfTransient_DownCast(AnObject)
...
class TColStd_StackOfInteger(object):
    ...
    def SetChangeTop(self, value):
        """SetChangeTop(TColStd_StackOfInteger self, Standard_Integer value)"""
        return _TColStd.TColStd_StackOfInteger_SetChangeTop(self, value)
...
class TColStd_StackOfReal(object):
    ...
    def SetChangeTop(self, value):
        ...
        return _TColStd.TColStd_StackOfReal_SetChangeTop(self, value)
...
def Handle_TColStd_StdMapNodeOfMapOfAsciiString_DownCast(AnObject):
...
def Handle_TColStd_StdMapNodeOfMapOfInteger_DownCast(AnObject):
...
def Handle_TColStd_StdMapNodeOfMapOfReal_DownCast(AnObject):
...
def Handle_TColStd_StdMapNodeOfMapOfTransient_DownCast(AnObject):
