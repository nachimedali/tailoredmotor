...
class xscontrol(object):
    ...
    def Session(pilot):
        ...
        """
        return _XSControl.xscontrol_Session(pilot)
    ...
    def Vars(pilot):
        ...
        """
        return _XSControl.xscontrol_Vars(pilot)
...
class XSControl_ConnectedShapes(OCC.IFSelect.IFSelect_SelectExplore):
    ...
    def SetReader(self, TR):
        ...
        """
        return _XSControl.XSControl_ConnectedShapes_SetReader(self, TR)


    def AdjacentEntities(ashape, TP, type):
        """
        Args:
        	ashape(TopoDS_Shape)
        ...
        """
        return _XSControl.XSControl_ConnectedShapes_AdjacentEntities(ashape, TP, type)
...
def XSControl_ConnectedShapes_AdjacentEntities(ashape, TP, type):
    """
    Args:
    	ashape(TopoDS_Shape)
    	TP(Handle_Transfer_TransientProcess)
...
def Handle_XSControl_ConnectedShapes_DownCast(AnObject):
    return _XSControl.Handle_XSControl_ConnectedShapes_DownCast(AnObject)
...
class XSControl_Controller(OCC.MMgt.MMgt_TShared):
    ...
    def SetNames(self, longname, shortname):
        """
        Args:
        	longname(char *)
        	shortname(char *)
        ...
        """
        return _XSControl.XSControl_Controller_SetNames(self, longname, shortname)
    ...
    def Record(self, name):
        ...
        """
        return _XSControl.XSControl_Controller_Record(self, name)
    ...
    def Recorded(name):
        ...
        """
        return _XSControl.XSControl_Controller_Recorded(name)
    ...
    def DefineProfile(self, confname):
        """
        Args:
        	confname(char *)
        ...
        """
        return _XSControl.XSControl_Controller_DefineProfile(self, confname)


    def SetProfile(self, confname):
        """
        Args:
        	confname(char *)
        ...
        """
        return _XSControl.XSControl_Controller_SetProfile(self, confname)


    def SettingProfile(self, confname):
        """
        Args:
        	confname(char *)
        ...
        """
        return _XSControl.XSControl_Controller_SettingProfile(self, confname)


    def ApplyProfile(self, WS, confname):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_Controller_ApplyProfile(self, WS, confname)


    def ApplyingProfile(self, WS, confname):
        """
        Args:
        	WS(Handle_XSControl_WorkSession)
        	confname(char *)
        ...
        Called by ApplyProfile, can be redefined for specific  
                  ...
                  The default does nothing
        """
        return _XSControl.XSControl_Controller_ApplyingProfile(self, WS, confname)
    ...
    def ActorRead(self, model):
        ...
        """
        return _XSControl.XSControl_Controller_ActorRead(self, model)
    ...
    def RecognizeWriteTransient(self, obj, modetrans=0):
        """
        Args:
        ...
        Tells if <obj> (an application object) is a valid candidate  
                  ...
                  TransientMapper). Can be redefined
        """
        return _XSControl.XSControl_Controller_RecognizeWriteTransient(self, obj, modetrans)


    def TransferWriteTransient(self, obj, FP, model, modetrans=0):
        """
        Args:
        	obj(Handle_Standard_Transient)
        ...
        Takes one Transient Object and transfers it to an  
                  ...
                  For type of object not recognized : should return 1
        """
        return _XSControl.XSControl_Controller_TransferWriteTransient(self, obj, FP, model, modetrans)


    def RecognizeWriteShape(self, shape, modetrans=0):
        """
        Args:
        	shape(TopoDS_Shape)
        	modetrans(Standard_Integer)=0
        ...
        Tells if a shape is valid for a transfer to a model  
                  Asks the ActorWrite (through a ShapeMapper)
        """
        return _XSControl.XSControl_Controller_RecognizeWriteShape(self, shape, modetrans)


    def TransferWriteShape(self, shape, FP, model, modetrans=0):
        """
        Args:
        	shape(TopoDS_Shape)
        	FP(Handle_Transfer_FinderProcess)
        ...
        Takes one Shape and transfers it to an  
         ...
         - ResolveCluster performs the resolution, its result consists in  
           having all data gathered in one final model
        """
        return _XSControl.XSControl_Controller_TransferWriteShape(self, shape, FP, model, modetrans)


    def ClusterContext(self, WS):
        """
        Args:
        	WS(Handle_XSControl_WorkSession)
        ...
        """
        return _XSControl.XSControl_Controller_ClusterContext(self, WS)


    def ResolveCluster(self, WS, context):
        """
        Args:
        	WS(Handle_XSControl_WorkSession)
        ...
        """
        return _XSControl.XSControl_Controller_ResolveCluster(self, WS, context)


    def AddControlItem(self, item, name):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_Controller_AddControlItem(self, item, name)


    def ControlItem(self, name):
        """
        Args:
        	name(char *)
        ...
        """
        return _XSControl.XSControl_Controller_ControlItem(self, name)


    def TraceStatic(self, name, use):
        """
        Args:
        	name(char *)
        ...
        """
        return _XSControl.XSControl_Controller_TraceStatic(self, name, use)
    ...
    def SessionItem(self, name):
        ...
        """
        return _XSControl.XSControl_Controller_SessionItem(self, name)


    def IsApplied(self, item):
        """
        Args:
        	item(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_Controller_IsApplied(self, item)


    def Customise(self, WS):
        """
        Args:
        	WS(Handle_XSControl_WorkSession)
        ...
        """
        return _XSControl.XSControl_Controller_Customise(self, WS)


    def Customising(self, WS):
        """
        Args:
        	WS(Handle_XSControl_WorkSession)
        ...
        """
        return _XSControl.XSControl_Controller_Customising(self, WS)
...
def XSControl_Controller_Recorded(name):
    """
    Args:
    	name(char *)
...
def Handle_XSControl_Controller_DownCast(AnObject):
    return _XSControl.Handle_XSControl_Controller_DownCast(AnObject)
...
class XSControl_FuncShape(object):
    ...
    def MoreShapes(session, list, name):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_FuncShape_MoreShapes(session, list, name)

    MoreShapes = staticmethod(MoreShapes)

    def FileAndVar(session, file, var, arg4, resfile, resvar):
        """
        Args:
        	session(Handle_XSControl_WorkSession)
        	file(char *)
        ...
        Analyses given file name and variable name, with a default  
                  ...
                  Else, <def> is taken
        """
        return _XSControl.XSControl_FuncShape_FileAndVar(session, file, var, arg4, resfile, resvar)
...
def XSControl_FuncShape_MoreShapes(session, list, name):
    """
    Args:
    	session(Handle_XSControl_WorkSession)
    	list(Handle_TopTools_HSequenceOfShape)
...
def XSControl_FuncShape_FileAndVar(session, file, var, arg5, resfile, resvar):
    """
    Args:
    	session(Handle_XSControl_WorkSession)
    	file(char *)
    ...
    Analyses given file name and variable name, with a default  
              ...
              Else, <def> is taken
    """
    return _XSControl.XSControl_FuncShape_FileAndVar(session, file, var, arg5, resfile, resvar)
...
class XSControl_Reader(object):
    ...
    def SetNorm(self, norm):
        ...
        """
        return _XSControl.XSControl_Reader_SetNorm(self, norm)
    ...
    def ReadFile(self, filename):
        ...
        """
        return _XSControl.XSControl_Reader_ReadFile(self, filename)
    ...
    def TransferOne(self, num):
        ...
        Translates an IGES or STEP  
                  ...
                  false is returned if no shape is produced.
        """
        return _XSControl.XSControl_Reader_TransferOne(self, num)


    def TransferEntity(self, start):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_Reader_TransferEntity(self, start)


    def TransferList(self, list):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_Reader_TransferList(self, list)
    ...
    def PrintCheckLoad(self, failsonly, mode):
        ...
        """
        return _XSControl.XSControl_Reader_PrintCheckLoad(self, failsonly, mode)
    ...
    def PrintCheckTransfer(self, failsonly, mode):
        ...
        """
        return _XSControl.XSControl_Reader_PrintCheckTransfer(self, failsonly, mode)


    def PrintStatsTransfer(self, what, mode=0):
        """
        Args:
        ...
        - if mode is 2 the list of entities per warning is returned.  
          If mode is not set, only the list of all entities per warning is given.
        """
        return _XSControl.XSControl_Reader_PrintStatsTransfer(self, what, mode)


    def GetStatsTransfer(self, list):
        """
        Args:
        	list(Handle_TColStd_HSequenceOfTransient)
        ...
        """
        return _XSControl.XSControl_Reader_GetStatsTransfer(self, list)
...
class XSControl_SelectForTransfer(OCC.IFSelect.IFSelect_SelectExtract):
    ...
    def SetReader(self, TR):
        ...
        """
        return _XSControl.XSControl_SelectForTransfer_SetReader(self, TR)


    def SetActor(self, act):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_SelectForTransfer_SetActor(self, act)
...
def Handle_XSControl_SelectForTransfer_DownCast(AnObject):
    return _XSControl.Handle_XSControl_SelectForTransfer_DownCast(AnObject)
...
class XSControl_SignTransferStatus(OCC.IFSelect.IFSelect_Signature):
    ...
    def SetReader(self, TR):
        ...
        """
        return _XSControl.XSControl_SignTransferStatus_SetReader(self, TR)
    ...
    def SetMap(self, TP):
        ...
        Sets a precise map to sign entities  
                  This definition oversedes the creation with a TransferReader
        """
        return _XSControl.XSControl_SignTransferStatus_SetMap(self, TP)
...
def Handle_XSControl_SignTransferStatus_DownCast(AnObject):
    return _XSControl.Handle_XSControl_SignTransferStatus_DownCast(AnObject)
...
class XSControl_TransferReader(OCC.MMgt.MMgt_TShared):
    ...
    def SetController(self, control):
        ...
        """
        return _XSControl.XSControl_TransferReader_SetController(self, control)
    ...
    def SetActor(self, actor):
        ...
        """
        return _XSControl.XSControl_TransferReader_SetActor(self, actor)
    ...
    def SetModel(self, model):
        ...
        """
        return _XSControl.XSControl_TransferReader_SetModel(self, model)
    ...
    def SetGraph(self, graph):
        ...
        """
        return _XSControl.XSControl_TransferReader_SetGraph(self, graph)
    ...
    def SetContext(self, name, ctx):
        ...
        """
        return _XSControl.XSControl_TransferReader_SetContext(self, name, ctx)


    def GetContext(self, name, type, ctx):
        """
        Args:
        	name(char *)
        ...
        """
        return _XSControl.XSControl_TransferReader_GetContext(self, name, type, ctx)
    ...
    def SetFileName(self, name):
        ...
        """
        return _XSControl.XSControl_TransferReader_SetFileName(self, name)
    ...
    def Clear(self, mode):
        ...
        """
        return _XSControl.XSControl_TransferReader_Clear(self, mode)
    ...
    def SetTransientProcess(self, TP):
        """
        Args:
        	TP(Handle_Transfer_TransientProcess)
        ...
        """
        return _XSControl.XSControl_TransferReader_SetTransientProcess(self, TP)


    def RecordResult(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_RecordResult(self, ent)


    def IsRecorded(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_IsRecorded(self, ent)


    def HasResult(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_HasResult(self, ent)
    ...
    def Skip(self, ent):
        ...
        """
        return _XSControl.XSControl_TransferReader_Skip(self, ent)


    def IsSkipped(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_IsSkipped(self, ent)


    def IsMarked(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_IsMarked(self, ent)


    def FinalResult(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_FinalResult(self, ent)


    def FinalEntityLabel(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_FinalEntityLabel(self, ent)


    def FinalEntityNumber(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_FinalEntityNumber(self, ent)


    def ResultFromNumber(self, num):
        """
        Args:
        	num(Standard_Integer)
        ...
        """
        return _XSControl.XSControl_TransferReader_ResultFromNumber(self, num)


    def TransientResult(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_TransientResult(self, ent)


    def ShapeResult(self, ent):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferReader_ShapeResult(self, ent)


    def ClearResult(self, ent, mode):
        """
        Args:
        	ent(Handle_Standard_Transient)
        	mode(Standard_Integer)
        ...
        """
        return _XSControl.XSControl_TransferReader_ClearResult(self, ent, mode)


    def EntityFromResult(self, res, mode=0):
        """
        Args:
        ...
        Returns an entity from which a given result was produced.  
                  ...
                  Returns a Null Handle if <res> not recorded
        """
        return _XSControl.XSControl_TransferReader_EntityFromResult(self, res, mode)


    def EntityFromShapeResult(self, res, mode=0):
        """
        Args:
        	res(TopoDS_Shape)
        	mode(Standard_Integer)=0
        ...
        Returns an entity from which a given shape result was produced  
                  Returns a Null Handle if <res> not recorded or not a Shape
        """
        return _XSControl.XSControl_TransferReader_EntityFromShapeResult(self, res, mode)


    def EntitiesFromShapeList(self, res, mode=0):
        """
        Args:
        ...
        Returns the list of entities from which some shapes were  
                  ...
                  but is optimised
        """
        return _XSControl.XSControl_TransferReader_EntitiesFromShapeList(self, res, mode)


    def CheckList(self, ent, level=0):
        """
        Args:
        	ent(Handle_Standard_Transient)
        ...
        Returns the CheckList resulting from transferring <ent>, i.e.  
                  ...
                  <level> : 0  for <ent> only (D)  
                            ...
                            2  for <ent> and subtransferts at all levels
        """
        return _XSControl.XSControl_TransferReader_CheckList(self, ent, level)


    def HasChecks(self, ent, failsonly):
        """
        Args:
        	ent(Handle_Standard_Transient)
        	failsonly(Standard_Boolean)
        ...
        """
        return _XSControl.XSControl_TransferReader_HasChecks(self, ent, failsonly)
    ...
    def Recognize(self, ent):
        ...
        """
        return _XSControl.XSControl_TransferReader_Recognize(self, ent)
    ...
    def TransferRoots(self, G):
        ...
        """
        return _XSControl.XSControl_TransferReader_TransferRoots(self, G)


    def TransferClear(self, ent, level=0):
        """
        Args:
        	ent(Handle_Standard_Transient)
        	level(Standard_Integer)=0
        ...
        Clears the results attached to an entity  
                  if <ents> equates the starting model, clears all results
        """
        return _XSControl.XSControl_TransferReader_TransferClear(self, ent, level)


    def PrintStats(self, what, mode=0):
        """
        Args:
        	what(Standard_Integer)
        	mode(Standard_Integer)=0
        ...
        Prints statistics on current Trace File, according <what> and  
                  <mode>.  See PrintStatsProcess for details
        """
        return _XSControl.XSControl_TransferReader_PrintStats(self, what, mode)
    ...
    def LastTransferList(self, roots):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_TransferReader_LastTransferList(self, roots)


    def ShapeResultList(self, rec):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_TransferReader_ShapeResultList(self, rec)


    def PrintStatsProcess(TP, what, mode=0):
        """
        Args:
        	TP(Handle_Transfer_TransientProcess)
        	what(Standard_Integer)
        ...
        This routines prints statistics about a TransientProcess  
                  ...
                  4 : EntitiesByItem    (count + entity numbers and labels)
        """
        return _XSControl.XSControl_TransferReader_PrintStatsProcess(TP, what, mode)

    PrintStatsProcess = staticmethod(PrintStatsProcess)

    def PrintStatsOnList(TP, list, what, mode=0):
        """
        Args:
        	TP(Handle_Transfer_TransientProcess)
        	list(Handle_TColStd_HSequenceOfTransient)
        ...
        Works as PrintStatsProcess, but displays data only on the  
                  entities which are in <list> (filter)
        """
        return _XSControl.XSControl_TransferReader_PrintStatsOnList(TP, list, what, mode)
...
def XSControl_TransferReader_PrintStatsProcess(TP, what, mode=0):
    """
    Args:
    	TP(Handle_Transfer_TransientProcess)
    	what(Standard_Integer)
...
def XSControl_TransferReader_PrintStatsOnList(TP, list, what, mode=0):
    """
    Args:
    	TP(Handle_Transfer_TransientProcess)
    	list(Handle_TColStd_HSequenceOfTransient)
...
def Handle_XSControl_TransferReader_DownCast(AnObject):
    return _XSControl.Handle_XSControl_TransferReader_DownCast(AnObject)
...
class XSControl_TransferWriter(OCC.MMgt.MMgt_TShared):
    ...
    def SetFinderProcess(self, FP):
        ...
        """
        return _XSControl.XSControl_TransferWriter_SetFinderProcess(self, FP)
    ...
    def SetController(self, ctl):
        ...
        """
        return _XSControl.XSControl_TransferWriter_SetController(self, ctl)
    ...
    def Clear(self, mode):
        ...
        """
        return _XSControl.XSControl_TransferWriter_Clear(self, mode)
    ...
    def SetTransferMode(self, mode):
        ...
        """
        return _XSControl.XSControl_TransferWriter_SetTransferMode(self, mode)
    ...
    def PrintStats(self, what, mode=0):
        ...
        Prints statistics on current Trace File, according what,mode  
                  See PrintStatsProcess for details
        """
        return _XSControl.XSControl_TransferWriter_PrintStats(self, what, mode)


    def RecognizeTransient(self, obj):
        """
        Args:
        	obj(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferWriter_RecognizeTransient(self, obj)


    def TransferWriteTransient(self, model, obj):
        """
        Args:
        	model(Handle_Interface_InterfaceModel)
        	obj(Handle_Standard_Transient)
        ...
        """
        return _XSControl.XSControl_TransferWriter_TransferWriteTransient(self, model, obj)


    def RecognizeShape(self, shape):
        """
        Args:
        	shape(TopoDS_Shape)
        ...
        """
        return _XSControl.XSControl_TransferWriter_RecognizeShape(self, shape)


    def TransferWriteShape(self, model, shape):
        """
        Args:
        	model(Handle_Interface_InterfaceModel)
        	shape(TopoDS_Shape)
        ...
        Transfers a Shape from CasCade to a model of current norm,  
                  ...
                  Returns status : =0 if OK, >0 if error during transfer, <0 if  
                      transfer badly initialised
        """
        return _XSControl.XSControl_TransferWriter_TransferWriteShape(self, model, shape)
    ...
    def ResultCheckList(self, model):
        """
        Args:
        	model(Handle_Interface_InterfaceModel)
        ...
        """
        return _XSControl.XSControl_TransferWriter_ResultCheckList(self, model)
    ...
    def PrintStatsProcess(TP, what, mode=0):
        ...
        Forecast to print statitics about a FinderProcess
        """
        return _XSControl.XSControl_TransferWriter_PrintStatsProcess(TP, what, mode)
...
def XSControl_TransferWriter_PrintStatsProcess(TP, what, mode=0):
    """
    Args:
    	TP(Handle_Transfer_FinderProcess)
    	what(Standard_Integer)
...
def Handle_XSControl_TransferWriter_DownCast(AnObject):
    return _XSControl.Handle_XSControl_TransferWriter_DownCast(AnObject)
...
class XSControl_Utils(object):
    ...
    def TraceLine(self, line):
        ...
        """
        return _XSControl.XSControl_Utils_TraceLine(self, line)


    def TraceLines(self, lines):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_Utils_TraceLines(self, lines)


    def IsKind(self, item, what):
        """
        Args:
        	item(Handle_Standard_Transient)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_IsKind(self, item, what)
    ...
    def TraValue(self, list, num):
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_TraValue(self, list, num)
    ...
    def AppendTra(self, seqval, traval):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_AppendTra(self, seqval, traval)


    def DateString(self, yy, mm, dd, hh, mn, ss):
        """
        Args:
        	yy(Standard_Integer)
        	mm(Standard_Integer)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_DateString(self, yy, mm, dd, hh, mn, ss)


    def DateValues(self, text):
        """
        Args:
        	text(char *)
        	yy(Standard_Integer)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_DateValues(self, text)
    ...
    def ToAString(self, strcon):
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_ToAString(self, strcon)
    ...
    def ToXString(self, strcon):
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_ToXString(self, strcon)


    def AsciiToExtended(self, str):
        """
        Args:
        	str(char *)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_AsciiToExtended(self, str)
    ...
    def IsAscii(self, str):
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_IsAscii(self, str)


    def ExtendedToAscii(self, str):
        """
        Args:
        	str(Standard_ExtString)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_ExtendedToAscii(self, str)


    def CStrValue(self, list, num):
        """
        Args:
        	list(Handle_Standard_Transient)
        	num(Standard_Integer)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_CStrValue(self, list, num)


    def EStrValue(self, list, num):
        """
        Args:
        	list(Handle_Standard_Transient)
        	num(Standard_Integer)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_EStrValue(self, list, num)
    ...
    def AppendCStr(self, seqval, strval):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_AppendCStr(self, seqval, strval)
    ...
    def AppendEStr(self, seqval, strval):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_AppendEStr(self, seqval, strval)


    def WriteShape(self, shape, filename):
        """
        Args:
        	shape(TopoDS_Shape)
        	filename(char *)
        ...
        """
        return _XSControl.XSControl_Utils_WriteShape(self, shape, filename)
    ...
    def ReadShape(self, shape, filename):
        """
        Args:
        	shape(TopoDS_Shape)
        	filename(char *)
        ...
        """
        return _XSControl.XSControl_Utils_ReadShape(self, shape, filename)


    def IsNullShape(self, shape):
        """
        Args:
        	shape(TopoDS_Shape)
        ...
        """
        return _XSControl.XSControl_Utils_IsNullShape(self, shape)


    def CompoundFromSeq(self, seqval):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_Utils_CompoundFromSeq(self, seqval)


    def ShapeType(self, shape, compound):
        """
        Args:
        	shape(TopoDS_Shape)
        ...
        """
        return _XSControl.XSControl_Utils_ShapeType(self, shape, compound)


    def SortedCompound(self, shape, type, explore, compound):
        """
        Args:
        	shape(TopoDS_Shape)
        	type(TopAbs_ShapeEnum)
        ...
        """
        return _XSControl.XSControl_Utils_SortedCompound(self, shape, type, explore, compound)


    def ShapeValue(self, seqv, num):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_ShapeValue(self, seqv, num)
    ...
    def AppendShape(self, seqv, shape):
        """
        Args:
        	seqv(Handle_TopTools_HSequenceOfShape)
        	shape(TopoDS_Shape)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_AppendShape(self, seqv, shape)
    ...
    def BinderShape(self, tr):
        ...
        """
        return _XSControl.XSControl_Utils_BinderShape(self, tr)


    def SeqLength(self, list):
        """
        Args:
        	list(Handle_Standard_Transient)
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_SeqLength(self, list)


    def SeqToArr(self, seq, first=1):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_SeqToArr(self, seq, first)


    def ArrToSeq(self, arr):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_ArrToSeq(self, arr)


    def SeqIntValue(self, list, num):
        """
        Args:
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_Utils_SeqIntValue(self, list, num)
...
class XSControl_WorkSession(OCC.IFSelect.IFSelect_WorkSession):
    ...
    def SelectProfile(self, profile):
        ...
        """
        return _XSControl.XSControl_WorkSession_SelectProfile(self, profile)
    ...
    def SetController(self, ctl):
        ...
        """
        return _XSControl.XSControl_WorkSession_SetController(self, ctl)
    ...
    def SetAllContext(self, context):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_WorkSession_SetAllContext(self, context)
    ...
    def PrintTransferStatus(self, num, wri, S):
        """
        Args:
        	num(Standard_Integer)
        ...
        """
        return _XSControl.XSControl_WorkSession_PrintTransferStatus(self, num, wri, S)


    def InitTransferReader(self, mode):
        """
        Args:
        	mode(Standard_Integer)
        ...
        """
        return _XSControl.XSControl_WorkSession_InitTransferReader(self, mode)


    def SetTransferReader(self, TR):
        """
        Args:
        	TR(Handle_XSControl_TransferReader)
        ...
        """
        return _XSControl.XSControl_WorkSession_SetTransferReader(self, TR)
    ...
    def SetMapReader(self, TP):
        ...
        """
        return _XSControl.XSControl_WorkSession_SetMapReader(self, TP)


    def Result(self, ent, mode):
        """
        Args:
        	ent(Handle_Standard_Transient)
        	mode(Standard_Integer)
        ...
        """
        return _XSControl.XSControl_WorkSession_Result(self, ent, mode)


    def TransferReadOne(self, ents):
        """
        Args:
        ...
        """
        return _XSControl.XSControl_WorkSession_TransferReadOne(self, ents)
    ...
    def SetMapWriter(self, FP):
        ...
        """
        return _XSControl.XSControl_WorkSession_SetMapWriter(self, FP)


    def SetModeWriteShape(self, mode):
        """
        Args:
        	mode(Standard_Integer)
        ...
        """
        return _XSControl.XSControl_WorkSession_SetModeWriteShape(self, mode)
    ...
    def SetVars(self, newvars):
        ...
        No detailed docstring for this function.
        """
        return _XSControl.XSControl_WorkSession_SetVars(self, newvars)
...
def Handle_XSControl_WorkSession_DownCast(AnObject):
    return _XSControl.Handle_XSControl_WorkSession_DownCast(AnObject)
...
class XSControl_Writer(object):
    ...
    def SetNorm(self, norm):
        ...
        Sets a specific norm to <self>  
                  Returns True if done, False if <norm> is not available
        """
        return _XSControl.XSControl_Writer_SetNorm(self, norm)
    ...
    def TransferShape(self, sh, mode=0):
        """
        Args:
        	sh(TopoDS_Shape)
        	mode(Standard_Integer)=0
        ...
        Transfers a Shape according to the mode
        """
        return _XSControl.XSControl_Writer_TransferShape(self, sh, mode)
    ...
    def WriteFile(self, filename):
        ...
        """
        return _XSControl.XSControl_Writer_WriteFile(self, filename)
    ...
    def PrintStatsTransfer(self, what, mode=0):
        ...
        Prints Statistics about Transfer
        """
        return _XSControl.XSControl_Writer_PrintStatsTransfer(self, what, mode)
