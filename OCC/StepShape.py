...
_StepShape.StepShape_Equal_swigconstant(_StepShape)
StepShape_Equal = _StepShape.StepShape_Equal

_StepShape.StepShape_Large_swigconstant(_StepShape)
StepShape_Large = _StepShape.StepShape_Large

_StepShape.StepShape_Small_swigconstant(_StepShape)
StepShape_Small = _StepShape.StepShape_Small

_StepShape.StepShape_boDifference_swigconstant(_StepShape)
StepShape_boDifference = _StepShape.StepShape_boDifference

_StepShape.StepShape_boIntersection_swigconstant(_StepShape)
StepShape_boIntersection = _StepShape.StepShape_boIntersection

_StepShape.StepShape_boUnion_swigconstant(_StepShape)
...
def Handle_StepShape_Block_DownCast(AnObject):
...
def Handle_StepShape_BooleanResult_DownCast(AnObject):
...
def Handle_StepShape_BoxDomain_DownCast(AnObject):
...
def Handle_StepShape_ConnectedFaceShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_ContextDependentShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_DefinitionalRepresentationAndShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_DimensionalCharacteristicRepresentation_DownCast(AnObject):
...
def Handle_StepShape_DimensionalLocation_DownCast(AnObject):
...
def Handle_StepShape_DimensionalSize_DownCast(AnObject):
...
def Handle_StepShape_EdgeBasedWireframeModel_DownCast(AnObject):
...
def Handle_StepShape_FaceBasedSurfaceModel_DownCast(AnObject):
...
def Handle_StepShape_GeometricSet_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfConnectedEdgeSet_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfConnectedFaceSet_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfEdge_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfFace_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfFaceBound_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfGeometricSetSelect_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfOrientedClosedShell_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfOrientedEdge_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfShell_DownCast(AnObject):
...
def Handle_StepShape_HArray1OfValueQualifier_DownCast(AnObject):
...
def Handle_StepShape_HalfSpaceSolid_DownCast(AnObject):
...
def Handle_StepShape_LimitsAndFits_DownCast(AnObject):
...
def Handle_StepShape_MeasureQualification_DownCast(AnObject):
...
def Handle_StepShape_MeasureRepresentationItemAndQualifiedRepresentationItem_DownCast(AnObject):
...
def Handle_StepShape_PlusMinusTolerance_DownCast(AnObject):
...
def Handle_StepShape_PrecisionQualifier_DownCast(AnObject):
...
def Handle_StepShape_QualifiedRepresentationItem_DownCast(AnObject):
...
def Handle_StepShape_RightAngularWedge_DownCast(AnObject):
...
def Handle_StepShape_RightCircularCone_DownCast(AnObject):
...
def Handle_StepShape_RightCircularCylinder_DownCast(AnObject):
...
def Handle_StepShape_ShapeDefinitionRepresentation_DownCast(AnObject):
...
def Handle_StepShape_ShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_ShellBasedSurfaceModel_DownCast(AnObject):
...
def Handle_StepShape_SolidModel_DownCast(AnObject):
...
def Handle_StepShape_Sphere_DownCast(AnObject):
...
def Handle_StepShape_ToleranceValue_DownCast(AnObject):
...
def Handle_StepShape_TopologicalRepresentationItem_DownCast(AnObject):
...
def Handle_StepShape_Torus_DownCast(AnObject):
...
def Handle_StepShape_TypeQualifier_DownCast(AnObject):
...
def Handle_StepShape_AdvancedBrepShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_AngularLocation_DownCast(AnObject):
...
def Handle_StepShape_AngularSize_DownCast(AnObject):
...
def Handle_StepShape_BoxedHalfSpace_DownCast(AnObject):
...
def Handle_StepShape_CompoundShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_ConnectedEdgeSet_DownCast(AnObject):
...
def Handle_StepShape_ConnectedFaceSet_DownCast(AnObject):
...
def Handle_StepShape_CsgShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_CsgSolid_DownCast(AnObject):
...
def Handle_StepShape_DimensionalLocationWithPath_DownCast(AnObject):
...
def Handle_StepShape_DimensionalSizeWithPath_DownCast(AnObject):
...
def Handle_StepShape_DirectedDimensionalLocation_DownCast(AnObject):
...
def Handle_StepShape_Edge_DownCast(AnObject):
...
def Handle_StepShape_EdgeBasedWireframeShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_Face_DownCast(AnObject):
...
def Handle_StepShape_FaceBound_DownCast(AnObject):
...
def Handle_StepShape_FacetedBrepShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_GeometricCurveSet_DownCast(AnObject):
...
def Handle_StepShape_GeometricallyBoundedSurfaceShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_GeometricallyBoundedWireframeShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_Loop_DownCast(AnObject):
...
def Handle_StepShape_LoopAndPath_DownCast(AnObject):
...
def Handle_StepShape_ManifoldSolidBrep_DownCast(AnObject):
...
def Handle_StepShape_ManifoldSurfaceShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_NonManifoldSurfaceShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_Path_DownCast(AnObject):
...
def Handle_StepShape_PointRepresentation_DownCast(AnObject):
...
def Handle_StepShape_ShapeDimensionRepresentation_DownCast(AnObject):
...
def Handle_StepShape_ShapeRepresentationWithParameters_DownCast(AnObject):
...
def Handle_StepShape_SolidReplica_DownCast(AnObject):
...
def Handle_StepShape_SweptAreaSolid_DownCast(AnObject):
...
def Handle_StepShape_SweptFaceSolid_DownCast(AnObject):
...
def Handle_StepShape_TransitionalShapeRepresentation_DownCast(AnObject):
...
def Handle_StepShape_Vertex_DownCast(AnObject):
...
def Handle_StepShape_BrepWithVoids_DownCast(AnObject):
...
def Handle_StepShape_ClosedShell_DownCast(AnObject):
...
def Handle_StepShape_ConnectedFaceSubSet_DownCast(AnObject):
...
def Handle_StepShape_EdgeCurve_DownCast(AnObject):
...
def Handle_StepShape_EdgeLoop_DownCast(AnObject):
...
def Handle_StepShape_ExtrudedAreaSolid_DownCast(AnObject):
...
def Handle_StepShape_ExtrudedFaceSolid_DownCast(AnObject):
...
def Handle_StepShape_FaceOuterBound_DownCast(AnObject):
...
def Handle_StepShape_FaceSurface_DownCast(AnObject):
...
def Handle_StepShape_FacetedBrep_DownCast(AnObject):
...
def Handle_StepShape_FacetedBrepAndBrepWithVoids_DownCast(AnObject):
...
def Handle_StepShape_OpenShell_DownCast(AnObject):
...
def Handle_StepShape_OrientedEdge_DownCast(AnObject):
...
def Handle_StepShape_OrientedFace_DownCast(AnObject):
...
def Handle_StepShape_OrientedPath_DownCast(AnObject):
...
def Handle_StepShape_PolyLoop_DownCast(AnObject):
...
def Handle_StepShape_RevolvedAreaSolid_DownCast(AnObject):
...
def Handle_StepShape_RevolvedFaceSolid_DownCast(AnObject):
...
def Handle_StepShape_Subedge_DownCast(AnObject):
...
def Handle_StepShape_Subface_DownCast(AnObject):
...
def Handle_StepShape_VertexLoop_DownCast(AnObject):
...
def Handle_StepShape_VertexPoint_DownCast(AnObject):
...
def Handle_StepShape_AdvancedFace_DownCast(AnObject):
...
def Handle_StepShape_OrientedClosedShell_DownCast(AnObject):
...
def Handle_StepShape_OrientedOpenShell_DownCast(AnObject):
...
def Handle_StepShape_SeamEdge_DownCast(AnObject):
