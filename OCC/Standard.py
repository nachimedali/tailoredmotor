...
_Standard.Standard_HandlerVoid_swigconstant(_Standard)
Standard_HandlerVoid = _Standard.Standard_HandlerVoid

_Standard.Standard_HandlerJumped_swigconstant(_Standard)
Standard_HandlerJumped = _Standard.Standard_HandlerJumped

_Standard.Standard_HandlerProcessed_swigconstant(_Standard)
Standard_HandlerProcessed = _Standard.Standard_HandlerProcessed

_Standard.Standard_Void_swigconstant(_Standard)
Standard_Void = _Standard.Standard_Void

_Standard.Standard_Char_swigconstant(_Standard)
Standard_Char = _Standard.Standard_Char

_Standard.Standard_ExtChar_swigconstant(_Standard)
Standard_ExtChar = _Standard.Standard_ExtChar

_Standard.Standard_LongInt_swigconstant(_Standard)
Standard_LongInt = _Standard.Standard_LongInt

_Standard.Standard_Bool_swigconstant(_Standard)
Standard_Bool = _Standard.Standard_Bool

_Standard.Standard_Float_swigconstant(_Standard)
Standard_Float = _Standard.Standard_Float

_Standard.Standard_LongDouble_swigconstant(_Standard)
Standard_LongDouble = _Standard.Standard_LongDouble

_Standard.Standard_String_swigconstant(_Standard)
Standard_String = _Standard.Standard_String

_Standard.Standard_EString_swigconstant(_Standard)
Standard_EString = _Standard.Standard_EString

_Standard.Standard_EntryAddress_swigconstant(_Standard)
Standard_EntryAddress = _Standard.Standard_EntryAddress

_Standard.Standard_DataAddress_swigconstant(_Standard)
Standard_DataAddress = _Standard.Standard_DataAddress

_Standard.Standard_EngineHandle_swigconstant(_Standard)
Standard_EngineHandle = _Standard.Standard_EngineHandle

_Standard.Standard_Long64_swigconstant(_Standard)
Standard_Long64 = _Standard.Standard_Long64

_Standard.Standard_Array_swigconstant(_Standard)
Standard_Array = _Standard.Standard_Array

_Standard.Standard_IsUnKnown_swigconstant(_Standard)
Standard_IsUnKnown = _Standard.Standard_IsUnKnown

_Standard.Standard_IsClass_swigconstant(_Standard)
Standard_IsClass = _Standard.Standard_IsClass

_Standard.Standard_IsEnumeration_swigconstant(_Standard)
Standard_IsEnumeration = _Standard.Standard_IsEnumeration

_Standard.Standard_IsPrimitive_swigconstant(_Standard)
Standard_IsPrimitive = _Standard.Standard_IsPrimitive

_Standard.Standard_IsImported_swigconstant(_Standard)
Standard_IsImported = _Standard.Standard_IsImported

_Standard.Standard_IsPackage_swigconstant(_Standard)
Standard_IsPackage = _Standard.Standard_IsPackage

_Standard.Standard_IsNothing_swigconstant(_Standard)
Standard_IsNothing = _Standard.Standard_IsNothing

_Standard.Standard_IsAddress_swigconstant(_Standard)
Standard_IsAddress = _Standard.Standard_IsAddress

_Standard.Standard_IsTransient_swigconstant(_Standard)
Standard_IsTransient = _Standard.Standard_IsTransient

_Standard.Standard_IsPersistent_swigconstant(_Standard)
Standard_IsPersistent = _Standard.Standard_IsPersistent

_Standard.Standard_IsNotLoaded_swigconstant(_Standard)
...
def Handle_Standard_Transient_DownCast(AnObject):
...
def Handle_Standard_Failure_DownCast(AnObject):
...
def Handle_Standard_Type_DownCast(AnObject):
