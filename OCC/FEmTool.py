...
def Handle_FEmTool_Curve_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_Curve_DownCast(AnObject)
...
def Handle_FEmTool_ElementaryCriterion_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_ElementaryCriterion_DownCast(AnObject)
...
def Handle_FEmTool_HAssemblyTable_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_HAssemblyTable_DownCast(AnObject)
...
def Handle_FEmTool_ListNodeOfListOfVectors_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_ListNodeOfListOfVectors_DownCast(AnObject)
...
def Handle_FEmTool_SequenceNodeOfSeqOfLinConstr_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_SequenceNodeOfSeqOfLinConstr_DownCast(AnObject)
...
def Handle_FEmTool_SparseMatrix_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_SparseMatrix_DownCast(AnObject)
...
def Handle_FEmTool_LinearFlexion_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_LinearFlexion_DownCast(AnObject)
...
def Handle_FEmTool_LinearJerk_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_LinearJerk_DownCast(AnObject)
...
def Handle_FEmTool_LinearTension_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_LinearTension_DownCast(AnObject)
...
def Handle_FEmTool_ProfileMatrix_DownCast(AnObject):
    return _FEmTool.Handle_FEmTool_ProfileMatrix_DownCast(AnObject)
