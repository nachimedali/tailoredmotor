...
_Intf.Intf_EXTERNAL_swigconstant(_Intf)
Intf_EXTERNAL = _Intf.Intf_EXTERNAL

_Intf.Intf_FACE_swigconstant(_Intf)
Intf_FACE = _Intf.Intf_FACE

_Intf.Intf_EDGE_swigconstant(_Intf)
Intf_EDGE = _Intf.Intf_EDGE

_Intf.Intf_VERTEX_swigconstant(_Intf)
...
def Handle_Intf_SequenceNodeOfSeqOfSectionLine_DownCast(AnObject):
...
def Handle_Intf_SequenceNodeOfSeqOfSectionPoint_DownCast(AnObject):
...
def Handle_Intf_SequenceNodeOfSeqOfTangentZone_DownCast(AnObject):
