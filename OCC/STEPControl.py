...
_STEPControl.STEPControl_AsIs_swigconstant(_STEPControl)
STEPControl_AsIs = _STEPControl.STEPControl_AsIs

_STEPControl.STEPControl_ManifoldSolidBrep_swigconstant(_STEPControl)
STEPControl_ManifoldSolidBrep = _STEPControl.STEPControl_ManifoldSolidBrep

_STEPControl.STEPControl_BrepWithVoids_swigconstant(_STEPControl)
STEPControl_BrepWithVoids = _STEPControl.STEPControl_BrepWithVoids

_STEPControl.STEPControl_FacetedBrep_swigconstant(_STEPControl)
STEPControl_FacetedBrep = _STEPControl.STEPControl_FacetedBrep

_STEPControl.STEPControl_FacetedBrepAndBrepWithVoids_swigconstant(_STEPControl)
STEPControl_FacetedBrepAndBrepWithVoids = _STEPControl.STEPControl_FacetedBrepAndBrepWithVoids

_STEPControl.STEPControl_ShellBasedSurfaceModel_swigconstant(_STEPControl)
STEPControl_ShellBasedSurfaceModel = _STEPControl.STEPControl_ShellBasedSurfaceModel

_STEPControl.STEPControl_GeometricCurveSet_swigconstant(_STEPControl)
STEPControl_GeometricCurveSet = _STEPControl.STEPControl_GeometricCurveSet

_STEPControl.STEPControl_Hybrid_swigconstant(_STEPControl)
...
def Handle_STEPControl_ActorRead_DownCast(AnObject):
    return _STEPControl.Handle_STEPControl_ActorRead_DownCast(AnObject)
...
def Handle_STEPControl_ActorWrite_DownCast(AnObject):
    return _STEPControl.Handle_STEPControl_ActorWrite_DownCast(AnObject)
...
def Handle_STEPControl_Controller_DownCast(AnObject):
    return _STEPControl.Handle_STEPControl_Controller_DownCast(AnObject)
