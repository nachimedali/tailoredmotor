...
def Handle_Bnd_HArray1OfBox_DownCast(AnObject):
    return _Bnd.Handle_Bnd_HArray1OfBox_DownCast(AnObject)
...
def Handle_Bnd_HArray1OfBox2d_DownCast(AnObject):
    return _Bnd.Handle_Bnd_HArray1OfBox2d_DownCast(AnObject)
...
def Handle_Bnd_HArray1OfSphere_DownCast(AnObject):
    return _Bnd.Handle_Bnd_HArray1OfSphere_DownCast(AnObject)
...
def Handle_Bnd_SequenceNodeOfSeqOfBox_DownCast(AnObject):
    return _Bnd.Handle_Bnd_SequenceNodeOfSeqOfBox_DownCast(AnObject)
