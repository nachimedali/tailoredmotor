...
def Handle_ShapeAnalysis_DataMapNodeOfDataMapOfShapeListOfReal_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_DataMapNodeOfDataMapOfShapeListOfReal_DownCast(AnObject)
...
def Handle_ShapeAnalysis_FreeBoundData_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_FreeBoundData_DownCast(AnObject)
...
def Handle_ShapeAnalysis_HSequenceOfFreeBounds_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_HSequenceOfFreeBounds_DownCast(AnObject)
...
def Handle_ShapeAnalysis_SequenceNodeOfSequenceOfFreeBounds_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_SequenceNodeOfSequenceOfFreeBounds_DownCast(AnObject)
...
def Handle_ShapeAnalysis_Surface_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_Surface_DownCast(AnObject)
...
def Handle_ShapeAnalysis_TransferParameters_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_TransferParameters_DownCast(AnObject)
...
def Handle_ShapeAnalysis_Wire_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_Wire_DownCast(AnObject)
...
def Handle_ShapeAnalysis_TransferParametersProj_DownCast(AnObject):
    return _ShapeAnalysis.Handle_ShapeAnalysis_TransferParametersProj_DownCast(AnObject)
