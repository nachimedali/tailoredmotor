...
_TDF.TDF_LabelNodeImportMsk_swigconstant(_TDF)
TDF_LabelNodeImportMsk = _TDF.TDF_LabelNodeImportMsk

_TDF.TDF_LabelNodeAttModMsk_swigconstant(_TDF)
TDF_LabelNodeAttModMsk = _TDF.TDF_LabelNodeAttModMsk

_TDF.TDF_LabelNodeMayModMsk_swigconstant(_TDF)
TDF_LabelNodeMayModMsk = _TDF.TDF_LabelNodeMayModMsk

_TDF.TDF_LabelNodeFlagsMsk_swigconstant(_TDF)
...
def Handle_TDF_Attribute_DownCast(AnObject):
    return _TDF.Handle_TDF_Attribute_DownCast(AnObject)
...
def Handle_TDF_AttributeDelta_DownCast(AnObject):
    return _TDF.Handle_TDF_AttributeDelta_DownCast(AnObject)
...
def Handle_TDF_Data_DownCast(AnObject):
    return _TDF.Handle_TDF_Data_DownCast(AnObject)
...
def Handle_TDF_DataMapNodeOfAttributeDataMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DataMapNodeOfAttributeDataMap_DownCast(AnObject)
...
def Handle_TDF_DataMapNodeOfLabelDataMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DataMapNodeOfLabelDataMap_DownCast(AnObject)
...
class TDF_DataMapNodeOfLabelIntegerMap(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _TDF.TDF_DataMapNodeOfLabelIntegerMap_SetValue(self, value)
...
def Handle_TDF_DataMapNodeOfLabelIntegerMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DataMapNodeOfLabelIntegerMap_DownCast(AnObject)
...
def Handle_TDF_DataMapNodeOfLabelLabelMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DataMapNodeOfLabelLabelMap_DownCast(AnObject)
...
def Handle_TDF_DataSet_DownCast(AnObject):
    return _TDF.Handle_TDF_DataSet_DownCast(AnObject)
...
def Handle_TDF_Delta_DownCast(AnObject):
    return _TDF.Handle_TDF_Delta_DownCast(AnObject)
...
def Handle_TDF_DoubleMapNodeOfAttributeDoubleMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DoubleMapNodeOfAttributeDoubleMap_DownCast(AnObject)
...
def Handle_TDF_DoubleMapNodeOfGUIDProgIDMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DoubleMapNodeOfGUIDProgIDMap_DownCast(AnObject)
...
def Handle_TDF_DoubleMapNodeOfLabelDoubleMap_DownCast(AnObject):
    return _TDF.Handle_TDF_DoubleMapNodeOfLabelDoubleMap_DownCast(AnObject)
...
def Handle_TDF_HAttributeArray1_DownCast(AnObject):
    return _TDF.Handle_TDF_HAttributeArray1_DownCast(AnObject)
...
class TDF_IndexedMapNodeOfAttributeIndexedMap(OCC.TCollection.TCollection_MapNode):
    ...
    def SetKey2(self, value):
        ...
        return _TDF.TDF_IndexedMapNodeOfAttributeIndexedMap_SetKey2(self, value)
...
def Handle_TDF_IndexedMapNodeOfAttributeIndexedMap_DownCast(AnObject):
    return _TDF.Handle_TDF_IndexedMapNodeOfAttributeIndexedMap_DownCast(AnObject)
...
class TDF_IndexedMapNodeOfLabelIndexedMap(OCC.TCollection.TCollection_MapNode):
    ...
    def SetKey2(self, value):
        ...
        return _TDF.TDF_IndexedMapNodeOfLabelIndexedMap_SetKey2(self, value)
...
def Handle_TDF_IndexedMapNodeOfLabelIndexedMap_DownCast(AnObject):
    return _TDF.Handle_TDF_IndexedMapNodeOfLabelIndexedMap_DownCast(AnObject)
...
def Handle_TDF_ListNodeOfAttributeDeltaList_DownCast(AnObject):
    return _TDF.Handle_TDF_ListNodeOfAttributeDeltaList_DownCast(AnObject)
...
def Handle_TDF_ListNodeOfAttributeList_DownCast(AnObject):
    return _TDF.Handle_TDF_ListNodeOfAttributeList_DownCast(AnObject)
...
def Handle_TDF_ListNodeOfDeltaList_DownCast(AnObject):
    return _TDF.Handle_TDF_ListNodeOfDeltaList_DownCast(AnObject)
...
def Handle_TDF_ListNodeOfIDList_DownCast(AnObject):
    return _TDF.Handle_TDF_ListNodeOfIDList_DownCast(AnObject)
...
def Handle_TDF_ListNodeOfLabelList_DownCast(AnObject):
    return _TDF.Handle_TDF_ListNodeOfLabelList_DownCast(AnObject)
...
def Handle_TDF_RelocationTable_DownCast(AnObject):
    return _TDF.Handle_TDF_RelocationTable_DownCast(AnObject)
...
def Handle_TDF_SequenceNodeOfAttributeSequence_DownCast(AnObject):
    return _TDF.Handle_TDF_SequenceNodeOfAttributeSequence_DownCast(AnObject)
...
def Handle_TDF_SequenceNodeOfLabelSequence_DownCast(AnObject):
    return _TDF.Handle_TDF_SequenceNodeOfLabelSequence_DownCast(AnObject)
...
def Handle_TDF_StdMapNodeOfAttributeMap_DownCast(AnObject):
    return _TDF.Handle_TDF_StdMapNodeOfAttributeMap_DownCast(AnObject)
...
def Handle_TDF_StdMapNodeOfIDMap_DownCast(AnObject):
    return _TDF.Handle_TDF_StdMapNodeOfIDMap_DownCast(AnObject)
...
def Handle_TDF_StdMapNodeOfLabelMap_DownCast(AnObject):
    return _TDF.Handle_TDF_StdMapNodeOfLabelMap_DownCast(AnObject)
...
def Handle_TDF_DeltaOnAddition_DownCast(AnObject):
    return _TDF.Handle_TDF_DeltaOnAddition_DownCast(AnObject)
...
def Handle_TDF_DeltaOnForget_DownCast(AnObject):
    return _TDF.Handle_TDF_DeltaOnForget_DownCast(AnObject)
...
def Handle_TDF_DeltaOnModification_DownCast(AnObject):
    return _TDF.Handle_TDF_DeltaOnModification_DownCast(AnObject)
...
def Handle_TDF_DeltaOnRemoval_DownCast(AnObject):
    return _TDF.Handle_TDF_DeltaOnRemoval_DownCast(AnObject)
...
def Handle_TDF_DeltaOnResume_DownCast(AnObject):
    return _TDF.Handle_TDF_DeltaOnResume_DownCast(AnObject)
...
def Handle_TDF_Reference_DownCast(AnObject):
    return _TDF.Handle_TDF_Reference_DownCast(AnObject)
...
def Handle_TDF_TagSource_DownCast(AnObject):
    return _TDF.Handle_TDF_TagSource_DownCast(AnObject)
...
def Handle_TDF_DefaultDeltaOnModification_DownCast(AnObject):
    return _TDF.Handle_TDF_DefaultDeltaOnModification_DownCast(AnObject)
...
def Handle_TDF_DefaultDeltaOnRemoval_DownCast(AnObject):
    return _TDF.Handle_TDF_DefaultDeltaOnRemoval_DownCast(AnObject)
