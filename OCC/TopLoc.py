...
def Handle_TopLoc_Datum3D_DownCast(AnObject):
...
def Handle_TopLoc_IndexedMapNodeOfIndexedMapOfLocation_DownCast(AnObject):
...
def Handle_TopLoc_SListNodeOfSListOfItemLocation_DownCast(AnObject):
    return _TopLoc.Handle_TopLoc_SListNodeOfSListOfItemLocation_DownCast(AnObject)
...
def Handle_TopLoc_StdMapNodeOfMapOfLocation_DownCast(AnObject):
