...
_XCAFDoc.XCAFDoc_ColorGen_swigconstant(_XCAFDoc)
XCAFDoc_ColorGen = _XCAFDoc.XCAFDoc_ColorGen

_XCAFDoc.XCAFDoc_ColorSurf_swigconstant(_XCAFDoc)
XCAFDoc_ColorSurf = _XCAFDoc.XCAFDoc_ColorSurf

_XCAFDoc.XCAFDoc_ColorCurv_swigconstant(_XCAFDoc)
...
def Handle_XCAFDoc_Area_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Area_DownCast(AnObject)
...
def Handle_XCAFDoc_Centroid_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Centroid_DownCast(AnObject)
...
def Handle_XCAFDoc_Color_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Color_DownCast(AnObject)
...
def Handle_XCAFDoc_ColorTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_ColorTool_DownCast(AnObject)
...
def Handle_XCAFDoc_DataMapNodeOfDataMapOfShapeLabel_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_DataMapNodeOfDataMapOfShapeLabel_DownCast(AnObject)
...
def Handle_XCAFDoc_Datum_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Datum_DownCast(AnObject)
...
def Handle_XCAFDoc_DimTol_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_DimTol_DownCast(AnObject)
...
def Handle_XCAFDoc_DimTolTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_DimTolTool_DownCast(AnObject)
...
def Handle_XCAFDoc_DocumentTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_DocumentTool_DownCast(AnObject)
...
def Handle_XCAFDoc_GraphNode_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_GraphNode_DownCast(AnObject)
...
def Handle_XCAFDoc_LayerTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_LayerTool_DownCast(AnObject)
...
def Handle_XCAFDoc_Location_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Location_DownCast(AnObject)
...
def Handle_XCAFDoc_Material_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Material_DownCast(AnObject)
...
def Handle_XCAFDoc_MaterialTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_MaterialTool_DownCast(AnObject)
...
def Handle_XCAFDoc_SequenceNodeOfGraphNodeSequence_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_SequenceNodeOfGraphNodeSequence_DownCast(AnObject)
...
def Handle_XCAFDoc_ShapeMapTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_ShapeMapTool_DownCast(AnObject)
...
def Handle_XCAFDoc_ShapeTool_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_ShapeTool_DownCast(AnObject)
...
def Handle_XCAFDoc_Volume_DownCast(AnObject):
    return _XCAFDoc.Handle_XCAFDoc_Volume_DownCast(AnObject)
