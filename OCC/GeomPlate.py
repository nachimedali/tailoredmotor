...
def Handle_GeomPlate_CurveConstraint_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_CurveConstraint_DownCast(AnObject)
...
def Handle_GeomPlate_HArray1OfHCurveOnSurface_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_HArray1OfHCurveOnSurface_DownCast(AnObject)
...
def Handle_GeomPlate_HArray1OfSequenceOfReal_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_HArray1OfSequenceOfReal_DownCast(AnObject)
...
def Handle_GeomPlate_HSequenceOfCurveConstraint_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_HSequenceOfCurveConstraint_DownCast(AnObject)
...
def Handle_GeomPlate_HSequenceOfPointConstraint_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_HSequenceOfPointConstraint_DownCast(AnObject)
...
def Handle_GeomPlate_PointConstraint_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_PointConstraint_DownCast(AnObject)
...
def Handle_GeomPlate_SequenceNodeOfSequenceOfAij_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_SequenceNodeOfSequenceOfAij_DownCast(AnObject)
...
def Handle_GeomPlate_SequenceNodeOfSequenceOfCurveConstraint_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_SequenceNodeOfSequenceOfCurveConstraint_DownCast(AnObject)
...
def Handle_GeomPlate_SequenceNodeOfSequenceOfPointConstraint_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_SequenceNodeOfSequenceOfPointConstraint_DownCast(AnObject)
...
def Handle_GeomPlate_Surface_DownCast(AnObject):
    return _GeomPlate.Handle_GeomPlate_Surface_DownCast(AnObject)
