...
_TopAbs.TopAbs_FORWARD_swigconstant(_TopAbs)
TopAbs_FORWARD = _TopAbs.TopAbs_FORWARD

_TopAbs.TopAbs_REVERSED_swigconstant(_TopAbs)
TopAbs_REVERSED = _TopAbs.TopAbs_REVERSED

_TopAbs.TopAbs_INTERNAL_swigconstant(_TopAbs)
TopAbs_INTERNAL = _TopAbs.TopAbs_INTERNAL

_TopAbs.TopAbs_EXTERNAL_swigconstant(_TopAbs)
TopAbs_EXTERNAL = _TopAbs.TopAbs_EXTERNAL

_TopAbs.TopAbs_COMPOUND_swigconstant(_TopAbs)
TopAbs_COMPOUND = _TopAbs.TopAbs_COMPOUND

_TopAbs.TopAbs_COMPSOLID_swigconstant(_TopAbs)
TopAbs_COMPSOLID = _TopAbs.TopAbs_COMPSOLID

_TopAbs.TopAbs_SOLID_swigconstant(_TopAbs)
TopAbs_SOLID = _TopAbs.TopAbs_SOLID

_TopAbs.TopAbs_SHELL_swigconstant(_TopAbs)
TopAbs_SHELL = _TopAbs.TopAbs_SHELL

_TopAbs.TopAbs_FACE_swigconstant(_TopAbs)
TopAbs_FACE = _TopAbs.TopAbs_FACE

_TopAbs.TopAbs_WIRE_swigconstant(_TopAbs)
TopAbs_WIRE = _TopAbs.TopAbs_WIRE

_TopAbs.TopAbs_EDGE_swigconstant(_TopAbs)
TopAbs_EDGE = _TopAbs.TopAbs_EDGE

_TopAbs.TopAbs_VERTEX_swigconstant(_TopAbs)
TopAbs_VERTEX = _TopAbs.TopAbs_VERTEX

_TopAbs.TopAbs_SHAPE_swigconstant(_TopAbs)
TopAbs_SHAPE = _TopAbs.TopAbs_SHAPE

_TopAbs.TopAbs_IN_swigconstant(_TopAbs)
TopAbs_IN = _TopAbs.TopAbs_IN

_TopAbs.TopAbs_OUT_swigconstant(_TopAbs)
TopAbs_OUT = _TopAbs.TopAbs_OUT

_TopAbs.TopAbs_ON_swigconstant(_TopAbs)
TopAbs_ON = _TopAbs.TopAbs_ON

_TopAbs.TopAbs_UNKNOWN_swigconstant(_TopAbs)
