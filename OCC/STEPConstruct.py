...
def Handle_STEPConstruct_DataMapNodeOfDataMapOfAsciiStringTransient_DownCast(AnObject):
    return _STEPConstruct.Handle_STEPConstruct_DataMapNodeOfDataMapOfAsciiStringTransient_DownCast(AnObject)
...
def Handle_STEPConstruct_DataMapNodeOfDataMapOfPointTransient_DownCast(AnObject):
    return _STEPConstruct.Handle_STEPConstruct_DataMapNodeOfDataMapOfPointTransient_DownCast(AnObject)
