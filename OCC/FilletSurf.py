...
_FilletSurf.FilletSurf_EmptyList_swigconstant(_FilletSurf)
FilletSurf_EmptyList = _FilletSurf.FilletSurf_EmptyList

_FilletSurf.FilletSurf_EdgeNotG1_swigconstant(_FilletSurf)
FilletSurf_EdgeNotG1 = _FilletSurf.FilletSurf_EdgeNotG1

_FilletSurf.FilletSurf_FacesNotG1_swigconstant(_FilletSurf)
FilletSurf_FacesNotG1 = _FilletSurf.FilletSurf_FacesNotG1

_FilletSurf.FilletSurf_EdgeNotOnShape_swigconstant(_FilletSurf)
FilletSurf_EdgeNotOnShape = _FilletSurf.FilletSurf_EdgeNotOnShape

_FilletSurf.FilletSurf_NotSharpEdge_swigconstant(_FilletSurf)
FilletSurf_NotSharpEdge = _FilletSurf.FilletSurf_NotSharpEdge

_FilletSurf.FilletSurf_PbFilletCompute_swigconstant(_FilletSurf)
FilletSurf_PbFilletCompute = _FilletSurf.FilletSurf_PbFilletCompute

_FilletSurf.FilletSurf_IsOk_swigconstant(_FilletSurf)
FilletSurf_IsOk = _FilletSurf.FilletSurf_IsOk

_FilletSurf.FilletSurf_IsNotOk_swigconstant(_FilletSurf)
FilletSurf_IsNotOk = _FilletSurf.FilletSurf_IsNotOk

_FilletSurf.FilletSurf_IsPartial_swigconstant(_FilletSurf)
FilletSurf_IsPartial = _FilletSurf.FilletSurf_IsPartial

_FilletSurf.FilletSurf_TwoExtremityOnEdge_swigconstant(_FilletSurf)
FilletSurf_TwoExtremityOnEdge = _FilletSurf.FilletSurf_TwoExtremityOnEdge

_FilletSurf.FilletSurf_OneExtremityOnEdge_swigconstant(_FilletSurf)
FilletSurf_OneExtremityOnEdge = _FilletSurf.FilletSurf_OneExtremityOnEdge

_FilletSurf.FilletSurf_NoExtremityOnEdge_swigconstant(_FilletSurf)
