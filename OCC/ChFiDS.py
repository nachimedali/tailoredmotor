...
_ChFiDS.ChFiDS_Sym_swigconstant(_ChFiDS)
ChFiDS_Sym = _ChFiDS.ChFiDS_Sym

_ChFiDS.ChFiDS_TwoDist_swigconstant(_ChFiDS)
ChFiDS_TwoDist = _ChFiDS.ChFiDS_TwoDist

_ChFiDS.ChFiDS_DistAngle_swigconstant(_ChFiDS)
ChFiDS_DistAngle = _ChFiDS.ChFiDS_DistAngle

_ChFiDS.ChFiDS_Ok_swigconstant(_ChFiDS)
ChFiDS_Ok = _ChFiDS.ChFiDS_Ok

_ChFiDS.ChFiDS_Error_swigconstant(_ChFiDS)
ChFiDS_Error = _ChFiDS.ChFiDS_Error

_ChFiDS.ChFiDS_WalkingFailure_swigconstant(_ChFiDS)
ChFiDS_WalkingFailure = _ChFiDS.ChFiDS_WalkingFailure

_ChFiDS.ChFiDS_StartsolFailure_swigconstant(_ChFiDS)
ChFiDS_StartsolFailure = _ChFiDS.ChFiDS_StartsolFailure

_ChFiDS.ChFiDS_TwistedSurface_swigconstant(_ChFiDS)
ChFiDS_TwistedSurface = _ChFiDS.ChFiDS_TwistedSurface

_ChFiDS.ChFiDS_OnSame_swigconstant(_ChFiDS)
ChFiDS_OnSame = _ChFiDS.ChFiDS_OnSame

_ChFiDS.ChFiDS_OnDiff_swigconstant(_ChFiDS)
ChFiDS_OnDiff = _ChFiDS.ChFiDS_OnDiff

_ChFiDS.ChFiDS_AllSame_swigconstant(_ChFiDS)
ChFiDS_AllSame = _ChFiDS.ChFiDS_AllSame

_ChFiDS.ChFiDS_BreakPoint_swigconstant(_ChFiDS)
ChFiDS_BreakPoint = _ChFiDS.ChFiDS_BreakPoint

_ChFiDS.ChFiDS_FreeBoundary_swigconstant(_ChFiDS)
ChFiDS_FreeBoundary = _ChFiDS.ChFiDS_FreeBoundary

_ChFiDS.ChFiDS_Closed_swigconstant(_ChFiDS)
ChFiDS_Closed = _ChFiDS.ChFiDS_Closed

_ChFiDS.ChFiDS_Tangent_swigconstant(_ChFiDS)
...
def Handle_ChFiDS_HData_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_HData_DownCast(AnObject)
...
def Handle_ChFiDS_HElSpine_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_HElSpine_DownCast(AnObject)
...
class ChFiDS_IndexedDataMapNodeOfIndexedDataMapOfVertexListOfStripe(OCC.TCollection.TCollection_MapNode):
    ...
    def SetKey2(self, value):
        ...
        return _ChFiDS.ChFiDS_IndexedDataMapNodeOfIndexedDataMapOfVertexListOfStripe_SetKey2(self, value)
...
def Handle_ChFiDS_IndexedDataMapNodeOfIndexedDataMapOfVertexListOfStripe_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_IndexedDataMapNodeOfIndexedDataMapOfVertexListOfStripe_DownCast(AnObject)
...
def Handle_ChFiDS_ListNodeOfListOfHElSpine_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_ListNodeOfListOfHElSpine_DownCast(AnObject)
...
def Handle_ChFiDS_ListNodeOfListOfStripe_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_ListNodeOfListOfStripe_DownCast(AnObject)
...
def Handle_ChFiDS_ListNodeOfRegularities_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_ListNodeOfRegularities_DownCast(AnObject)
...
def Handle_ChFiDS_SecHArray1_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_SecHArray1_DownCast(AnObject)
...
def Handle_ChFiDS_SequenceNodeOfSequenceOfSpine_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_SequenceNodeOfSequenceOfSpine_DownCast(AnObject)
...
def Handle_ChFiDS_SequenceNodeOfSequenceOfSurfData_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_SequenceNodeOfSequenceOfSurfData_DownCast(AnObject)
...
def Handle_ChFiDS_Spine_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_Spine_DownCast(AnObject)
...
def Handle_ChFiDS_Stripe_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_Stripe_DownCast(AnObject)
...
def Handle_ChFiDS_SurfData_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_SurfData_DownCast(AnObject)
...
def Handle_ChFiDS_ChamfSpine_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_ChamfSpine_DownCast(AnObject)
...
def Handle_ChFiDS_FilSpine_DownCast(AnObject):
    return _ChFiDS.Handle_ChFiDS_FilSpine_DownCast(AnObject)
