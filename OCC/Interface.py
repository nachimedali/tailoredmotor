...
_Interface.Interface_CheckOK_swigconstant(_Interface)
Interface_CheckOK = _Interface.Interface_CheckOK

_Interface.Interface_CheckWarning_swigconstant(_Interface)
Interface_CheckWarning = _Interface.Interface_CheckWarning

_Interface.Interface_CheckFail_swigconstant(_Interface)
Interface_CheckFail = _Interface.Interface_CheckFail

_Interface.Interface_CheckAny_swigconstant(_Interface)
Interface_CheckAny = _Interface.Interface_CheckAny

_Interface.Interface_CheckMessage_swigconstant(_Interface)
Interface_CheckMessage = _Interface.Interface_CheckMessage

_Interface.Interface_CheckNoFail_swigconstant(_Interface)
Interface_CheckNoFail = _Interface.Interface_CheckNoFail

_Interface.Interface_StateOK_swigconstant(_Interface)
Interface_StateOK = _Interface.Interface_StateOK

_Interface.Interface_LoadWarning_swigconstant(_Interface)
Interface_LoadWarning = _Interface.Interface_LoadWarning

_Interface.Interface_LoadFail_swigconstant(_Interface)
Interface_LoadFail = _Interface.Interface_LoadFail

_Interface.Interface_DataWarning_swigconstant(_Interface)
Interface_DataWarning = _Interface.Interface_DataWarning

_Interface.Interface_DataFail_swigconstant(_Interface)
Interface_DataFail = _Interface.Interface_DataFail

_Interface.Interface_StateUnloaded_swigconstant(_Interface)
Interface_StateUnloaded = _Interface.Interface_StateUnloaded

_Interface.Interface_StateUnknown_swigconstant(_Interface)
Interface_StateUnknown = _Interface.Interface_StateUnknown

_Interface.Interface_ParamMisc_swigconstant(_Interface)
Interface_ParamMisc = _Interface.Interface_ParamMisc

_Interface.Interface_ParamInteger_swigconstant(_Interface)
Interface_ParamInteger = _Interface.Interface_ParamInteger

_Interface.Interface_ParamReal_swigconstant(_Interface)
Interface_ParamReal = _Interface.Interface_ParamReal

_Interface.Interface_ParamIdent_swigconstant(_Interface)
Interface_ParamIdent = _Interface.Interface_ParamIdent

_Interface.Interface_ParamVoid_swigconstant(_Interface)
Interface_ParamVoid = _Interface.Interface_ParamVoid

_Interface.Interface_ParamText_swigconstant(_Interface)
Interface_ParamText = _Interface.Interface_ParamText

_Interface.Interface_ParamEnum_swigconstant(_Interface)
Interface_ParamEnum = _Interface.Interface_ParamEnum

_Interface.Interface_ParamLogical_swigconstant(_Interface)
Interface_ParamLogical = _Interface.Interface_ParamLogical

_Interface.Interface_ParamSub_swigconstant(_Interface)
Interface_ParamSub = _Interface.Interface_ParamSub

_Interface.Interface_ParamHexa_swigconstant(_Interface)
Interface_ParamHexa = _Interface.Interface_ParamHexa

_Interface.Interface_ParamBinary_swigconstant(_Interface)
...
def Handle_Interface_Check_DownCast(AnObject):
    return _Interface.Handle_Interface_Check_DownCast(AnObject)
...
def Handle_Interface_CopyControl_DownCast(AnObject):
    return _Interface.Handle_Interface_CopyControl_DownCast(AnObject)
...
class Interface_DataMapNodeOfDataMapOfTransientInteger(OCC.TCollection.TCollection_MapNode):
    ...
    def SetValue(self, value):
        ...
        return _Interface.Interface_DataMapNodeOfDataMapOfTransientInteger_SetValue(self, value)
...
def Handle_Interface_DataMapNodeOfDataMapOfTransientInteger_DownCast(AnObject):
    return _Interface.Handle_Interface_DataMapNodeOfDataMapOfTransientInteger_DownCast(AnObject)
...
def Handle_Interface_EntityCluster_DownCast(AnObject):
    return _Interface.Handle_Interface_EntityCluster_DownCast(AnObject)
...
def Handle_Interface_FileReaderData_DownCast(AnObject):
    return _Interface.Handle_Interface_FileReaderData_DownCast(AnObject)
...
def Handle_Interface_GTool_DownCast(AnObject):
    return _Interface.Handle_Interface_GTool_DownCast(AnObject)
...
def Handle_Interface_GeneralModule_DownCast(AnObject):
    return _Interface.Handle_Interface_GeneralModule_DownCast(AnObject)
...
def Handle_Interface_GlobalNodeOfGeneralLib_DownCast(AnObject):
    return _Interface.Handle_Interface_GlobalNodeOfGeneralLib_DownCast(AnObject)
...
def Handle_Interface_GlobalNodeOfReaderLib_DownCast(AnObject):
    return _Interface.Handle_Interface_GlobalNodeOfReaderLib_DownCast(AnObject)
...
def Handle_Interface_HArray1OfHAsciiString_DownCast(AnObject):
    return _Interface.Handle_Interface_HArray1OfHAsciiString_DownCast(AnObject)
...
def Handle_Interface_HGraph_DownCast(AnObject):
    return _Interface.Handle_Interface_HGraph_DownCast(AnObject)
...
def Handle_Interface_HSequenceOfCheck_DownCast(AnObject):
    return _Interface.Handle_Interface_HSequenceOfCheck_DownCast(AnObject)
...
class Interface_IndexedMapNodeOfIndexedMapOfAsciiString(OCC.TCollection.TCollection_MapNode):
    ...
    def SetKey2(self, value):
        ...
        return _Interface.Interface_IndexedMapNodeOfIndexedMapOfAsciiString_SetKey2(self, value)
...
def Handle_Interface_IndexedMapNodeOfIndexedMapOfAsciiString_DownCast(AnObject):
    return _Interface.Handle_Interface_IndexedMapNodeOfIndexedMapOfAsciiString_DownCast(AnObject)
...
def Handle_Interface_IntVal_DownCast(AnObject):
    return _Interface.Handle_Interface_IntVal_DownCast(AnObject)
...
def Handle_Interface_InterfaceModel_DownCast(AnObject):
    return _Interface.Handle_Interface_InterfaceModel_DownCast(AnObject)
...
def Handle_Interface_NodeOfGeneralLib_DownCast(AnObject):
    return _Interface.Handle_Interface_NodeOfGeneralLib_DownCast(AnObject)
...
def Handle_Interface_NodeOfReaderLib_DownCast(AnObject):
    return _Interface.Handle_Interface_NodeOfReaderLib_DownCast(AnObject)
...
def Handle_Interface_ParamList_DownCast(AnObject):
    return _Interface.Handle_Interface_ParamList_DownCast(AnObject)
...
def Handle_Interface_ParamSet_DownCast(AnObject):
    return _Interface.Handle_Interface_ParamSet_DownCast(AnObject)
...
def Handle_Interface_Protocol_DownCast(AnObject):
    return _Interface.Handle_Interface_Protocol_DownCast(AnObject)
...
def Handle_Interface_ReaderModule_DownCast(AnObject):
    return _Interface.Handle_Interface_ReaderModule_DownCast(AnObject)
...
def Handle_Interface_ReportEntity_DownCast(AnObject):
    return _Interface.Handle_Interface_ReportEntity_DownCast(AnObject)
...
def Handle_Interface_SequenceNodeOfSequenceOfCheck_DownCast(AnObject):
    return _Interface.Handle_Interface_SequenceNodeOfSequenceOfCheck_DownCast(AnObject)
...
def Handle_Interface_SignLabel_DownCast(AnObject):
    return _Interface.Handle_Interface_SignLabel_DownCast(AnObject)
...
def Handle_Interface_SignType_DownCast(AnObject):
    return _Interface.Handle_Interface_SignType_DownCast(AnObject)
...
def Handle_Interface_TypedValue_DownCast(AnObject):
    return _Interface.Handle_Interface_TypedValue_DownCast(AnObject)
...
def Handle_Interface_UndefinedContent_DownCast(AnObject):
    return _Interface.Handle_Interface_UndefinedContent_DownCast(AnObject)
...
def Handle_Interface_CopyMap_DownCast(AnObject):
    return _Interface.Handle_Interface_CopyMap_DownCast(AnObject)
...
def Handle_Interface_Static_DownCast(AnObject):
    return _Interface.Handle_Interface_Static_DownCast(AnObject)
