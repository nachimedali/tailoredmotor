...
_gce.gce_Done_swigconstant(_gce)
gce_Done = _gce.gce_Done

_gce.gce_ConfusedPoints_swigconstant(_gce)
gce_ConfusedPoints = _gce.gce_ConfusedPoints

_gce.gce_NegativeRadius_swigconstant(_gce)
gce_NegativeRadius = _gce.gce_NegativeRadius

_gce.gce_ColinearPoints_swigconstant(_gce)
gce_ColinearPoints = _gce.gce_ColinearPoints

_gce.gce_IntersectionError_swigconstant(_gce)
gce_IntersectionError = _gce.gce_IntersectionError

_gce.gce_NullAxis_swigconstant(_gce)
gce_NullAxis = _gce.gce_NullAxis

_gce.gce_NullAngle_swigconstant(_gce)
gce_NullAngle = _gce.gce_NullAngle

_gce.gce_NullRadius_swigconstant(_gce)
gce_NullRadius = _gce.gce_NullRadius

_gce.gce_InvertAxis_swigconstant(_gce)
gce_InvertAxis = _gce.gce_InvertAxis

_gce.gce_BadAngle_swigconstant(_gce)
gce_BadAngle = _gce.gce_BadAngle

_gce.gce_InvertRadius_swigconstant(_gce)
gce_InvertRadius = _gce.gce_InvertRadius

_gce.gce_NullFocusLength_swigconstant(_gce)
gce_NullFocusLength = _gce.gce_NullFocusLength

_gce.gce_NullVector_swigconstant(_gce)
gce_NullVector = _gce.gce_NullVector

_gce.gce_BadEquation_swigconstant(_gce)
