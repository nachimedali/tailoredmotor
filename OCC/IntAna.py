...
_IntAna.IntAna_Point_swigconstant(_IntAna)
IntAna_Point = _IntAna.IntAna_Point

_IntAna.IntAna_Line_swigconstant(_IntAna)
IntAna_Line = _IntAna.IntAna_Line

_IntAna.IntAna_Circle_swigconstant(_IntAna)
IntAna_Circle = _IntAna.IntAna_Circle

_IntAna.IntAna_PointAndCircle_swigconstant(_IntAna)
IntAna_PointAndCircle = _IntAna.IntAna_PointAndCircle

_IntAna.IntAna_Ellipse_swigconstant(_IntAna)
IntAna_Ellipse = _IntAna.IntAna_Ellipse

_IntAna.IntAna_Parabola_swigconstant(_IntAna)
IntAna_Parabola = _IntAna.IntAna_Parabola

_IntAna.IntAna_Hyperbola_swigconstant(_IntAna)
IntAna_Hyperbola = _IntAna.IntAna_Hyperbola

_IntAna.IntAna_Empty_swigconstant(_IntAna)
IntAna_Empty = _IntAna.IntAna_Empty

_IntAna.IntAna_Same_swigconstant(_IntAna)
IntAna_Same = _IntAna.IntAna_Same

_IntAna.IntAna_NoGeometricSolution_swigconstant(_IntAna)
...
IntAna_Curve.InternalUVValue = new_instancemethod(_IntAna.IntAna_Curve_InternalUVValue, None, IntAna_Curve)
...
class IntAna_ListIteratorOfListOfCurve(object):
    ...
    def Value(self, *args):
        ...
        """
        return _IntAna.IntAna_ListIteratorOfListOfCurve_Value(self, *args)

    __swig_destroy__ = _IntAna.delete_IntAna_ListIteratorOfListOfCurve
IntAna_ListIteratorOfListOfCurve.Initialize = new_instancemethod(_IntAna.IntAna_ListIteratorOfListOfCurve_Initialize, None, IntAna_ListIteratorOfListOfCurve)
...
class IntAna_ListNodeOfListOfCurve(OCC.TCollection.TCollection_MapNode):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    __swig_destroy__ = _IntAna.delete_IntAna_ListNodeOfListOfCurve
IntAna_ListNodeOfListOfCurve.Value = new_instancemethod(_IntAna.IntAna_ListNodeOfListOfCurve_Value, None, IntAna_ListNodeOfListOfCurve)
IntAna_ListNodeOfListOfCurve_swigregister = _IntAna.IntAna_ListNodeOfListOfCurve_swigregister
IntAna_ListNodeOfListOfCurve_swigregister(IntAna_ListNodeOfListOfCurve)

class Handle_IntAna_ListNodeOfListOfCurve(OCC.TCollection.Handle_TCollection_MapNode):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _IntAna.Handle_IntAna_ListNodeOfListOfCurve_swiginit(self, _IntAna.new_Handle_IntAna_ListNodeOfListOfCurve(*args))
    ...
    DownCast = staticmethod(_IntAna.Handle_IntAna_ListNodeOfListOfCurve_DownCast)
    __swig_destroy__ = _IntAna.delete_Handle_IntAna_ListNodeOfListOfCurve
Handle_IntAna_ListNodeOfListOfCurve.Nullify = new_instancemethod(_IntAna.Handle_IntAna_ListNodeOfListOfCurve_Nullify, None, Handle_IntAna_ListNodeOfListOfCurve)
Handle_IntAna_ListNodeOfListOfCurve.IsNull = new_instancemethod(_IntAna.Handle_IntAna_ListNodeOfListOfCurve_IsNull, None, Handle_IntAna_ListNodeOfListOfCurve)
Handle_IntAna_ListNodeOfListOfCurve.GetObject = new_instancemethod(_IntAna.Handle_IntAna_ListNodeOfListOfCurve_GetObject, None, Handle_IntAna_ListNodeOfListOfCurve)
...
def Handle_IntAna_ListNodeOfListOfCurve_DownCast(AnObject):
    return _IntAna.Handle_IntAna_ListNodeOfListOfCurve_DownCast(AnObject)
...
IntAna_ListOfCurve.Extent = new_instancemethod(_IntAna.IntAna_ListOfCurve_Extent, None, IntAna_ListOfCurve)
IntAna_ListOfCurve.Clear = new_instancemethod(_IntAna.IntAna_ListOfCurve_Clear, None, IntAna_ListOfCurve)
IntAna_ListOfCurve.IsEmpty = new_instancemethod(_IntAna.IntAna_ListOfCurve_IsEmpty, None, IntAna_ListOfCurve)
