...
def Handle_HLRBRep_AreaLimit_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_AreaLimit_DownCast(AnObject)
...
def Handle_HLRBRep_Data_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_Data_DownCast(AnObject)
...
def Handle_HLRBRep_InternalAlgo_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_InternalAlgo_DownCast(AnObject)
...
def Handle_HLRBRep_ListNodeOfListOfBPnt2D_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_ListNodeOfListOfBPnt2D_DownCast(AnObject)
...
def Handle_HLRBRep_ListNodeOfListOfBPoint_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_ListNodeOfListOfBPoint_DownCast(AnObject)
...
def Handle_HLRBRep_PolyAlgo_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_PolyAlgo_DownCast(AnObject)
...
def Handle_HLRBRep_SequenceNodeOfSeqOfShapeBounds_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_SequenceNodeOfSeqOfShapeBounds_DownCast(AnObject)
...
def Handle_HLRBRep_SequenceNodeOfSeqPCOfPCLocFOfTheLocateExtPCOfTheProjPCurOfCInter_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_SequenceNodeOfSeqPCOfPCLocFOfTheLocateExtPCOfTheProjPCurOfCInter_DownCast(AnObject)
...
def Handle_HLRBRep_Algo_DownCast(AnObject):
    return _HLRBRep.Handle_HLRBRep_Algo_DownCast(AnObject)
