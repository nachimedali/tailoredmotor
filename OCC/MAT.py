...
_MAT.MAT_Left_swigconstant(_MAT)
MAT_Left = _MAT.MAT_Left

_MAT.MAT_Right_swigconstant(_MAT)
...
def Handle_MAT_Arc_DownCast(AnObject):
...
def Handle_MAT_BasicElt_DownCast(AnObject):
...
def Handle_MAT_Bisector_DownCast(AnObject):
...
def Handle_MAT_DataMapNodeOfDataMapOfIntegerArc_DownCast(AnObject):
...
def Handle_MAT_DataMapNodeOfDataMapOfIntegerBasicElt_DownCast(AnObject):
...
def Handle_MAT_DataMapNodeOfDataMapOfIntegerBisector_DownCast(AnObject):
...
def Handle_MAT_DataMapNodeOfDataMapOfIntegerNode_DownCast(AnObject):
...
def Handle_MAT_Edge_DownCast(AnObject):
...
def Handle_MAT_Graph_DownCast(AnObject):
...
def Handle_MAT_ListOfBisector_DownCast(AnObject):
...
def Handle_MAT_ListOfEdge_DownCast(AnObject):
...
def Handle_MAT_Node_DownCast(AnObject):
...
def Handle_MAT_SequenceNodeOfSequenceOfArc_DownCast(AnObject):
...
def Handle_MAT_SequenceNodeOfSequenceOfBasicElt_DownCast(AnObject):
...
def Handle_MAT_TListNodeOfListOfBisector_DownCast(AnObject):
...
def Handle_MAT_TListNodeOfListOfEdge_DownCast(AnObject):
...
def Handle_MAT_Zone_DownCast(AnObject):
