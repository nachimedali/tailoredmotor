...
def Handle_TShort_HArray1OfShortReal_DownCast(AnObject):
    return _TShort.Handle_TShort_HArray1OfShortReal_DownCast(AnObject)
...
def Handle_TShort_HArray2OfShortReal_DownCast(AnObject):
    return _TShort.Handle_TShort_HArray2OfShortReal_DownCast(AnObject)
...
def Handle_TShort_HSequenceOfShortReal_DownCast(AnObject):
    return _TShort.Handle_TShort_HSequenceOfShortReal_DownCast(AnObject)
...
def Handle_TShort_SequenceNodeOfSequenceOfShortReal_DownCast(AnObject):
    return _TShort.Handle_TShort_SequenceNodeOfSequenceOfShortReal_DownCast(AnObject)
