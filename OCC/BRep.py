...
def Handle_BRep_CurveRepresentation_DownCast(AnObject):
    return _BRep.Handle_BRep_CurveRepresentation_DownCast(AnObject)
...
def Handle_BRep_ListNodeOfListOfCurveRepresentation_DownCast(AnObject):
    return _BRep.Handle_BRep_ListNodeOfListOfCurveRepresentation_DownCast(AnObject)
...
def Handle_BRep_ListNodeOfListOfPointRepresentation_DownCast(AnObject):
    return _BRep.Handle_BRep_ListNodeOfListOfPointRepresentation_DownCast(AnObject)
...
def Handle_BRep_PointRepresentation_DownCast(AnObject):
    return _BRep.Handle_BRep_PointRepresentation_DownCast(AnObject)
...
def Handle_BRep_TEdge_DownCast(AnObject):
    return _BRep.Handle_BRep_TEdge_DownCast(AnObject)
...
def Handle_BRep_TFace_DownCast(AnObject):
    return _BRep.Handle_BRep_TFace_DownCast(AnObject)
...
def Handle_BRep_TVertex_DownCast(AnObject):
    return _BRep.Handle_BRep_TVertex_DownCast(AnObject)
...
def Handle_BRep_CurveOn2Surfaces_DownCast(AnObject):
    return _BRep.Handle_BRep_CurveOn2Surfaces_DownCast(AnObject)
...
def Handle_BRep_GCurve_DownCast(AnObject):
    return _BRep.Handle_BRep_GCurve_DownCast(AnObject)
...
def Handle_BRep_PointOnCurve_DownCast(AnObject):
    return _BRep.Handle_BRep_PointOnCurve_DownCast(AnObject)
...
def Handle_BRep_PointsOnSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_PointsOnSurface_DownCast(AnObject)
...
def Handle_BRep_Polygon3D_DownCast(AnObject):
    return _BRep.Handle_BRep_Polygon3D_DownCast(AnObject)
...
def Handle_BRep_PolygonOnSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_PolygonOnSurface_DownCast(AnObject)
...
def Handle_BRep_PolygonOnTriangulation_DownCast(AnObject):
    return _BRep.Handle_BRep_PolygonOnTriangulation_DownCast(AnObject)
...
def Handle_BRep_Curve3D_DownCast(AnObject):
    return _BRep.Handle_BRep_Curve3D_DownCast(AnObject)
...
def Handle_BRep_CurveOnSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_CurveOnSurface_DownCast(AnObject)
...
def Handle_BRep_PointOnCurveOnSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_PointOnCurveOnSurface_DownCast(AnObject)
...
def Handle_BRep_PointOnSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_PointOnSurface_DownCast(AnObject)
...
def Handle_BRep_PolygonOnClosedSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_PolygonOnClosedSurface_DownCast(AnObject)
...
def Handle_BRep_PolygonOnClosedTriangulation_DownCast(AnObject):
    return _BRep.Handle_BRep_PolygonOnClosedTriangulation_DownCast(AnObject)
...
def Handle_BRep_CurveOnClosedSurface_DownCast(AnObject):
    return _BRep.Handle_BRep_CurveOnClosedSurface_DownCast(AnObject)
