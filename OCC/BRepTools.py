...
def Handle_BRepTools_DataMapNodeOfMapOfVertexPnt2d_DownCast(AnObject):
    return _BRepTools.Handle_BRepTools_DataMapNodeOfMapOfVertexPnt2d_DownCast(AnObject)
...
def Handle_BRepTools_Modification_DownCast(AnObject):
    return _BRepTools.Handle_BRepTools_Modification_DownCast(AnObject)
...
class BRepTools_ReShape(OCC.MMgt.MMgt_TShared):
    ...
    def SetModeConsiderLocation(self, value):
    ...
    def SetModeConsiderOrientation(self, value):
        """SetModeConsiderOrientation(BRepTools_ReShape self, Standard_Boolean value)"""
        return _BRepTools.BRepTools_ReShape_SetModeConsiderOrientation(self, value)
...
def Handle_BRepTools_ReShape_DownCast(AnObject):
    return _BRepTools.Handle_BRepTools_ReShape_DownCast(AnObject)
...
def Handle_BRepTools_GTrsfModification_DownCast(AnObject):
    return _BRepTools.Handle_BRepTools_GTrsfModification_DownCast(AnObject)
...
def Handle_BRepTools_NurbsConvertModification_DownCast(AnObject):
    return _BRepTools.Handle_BRepTools_NurbsConvertModification_DownCast(AnObject)
...
def Handle_BRepTools_TrsfModification_DownCast(AnObject):
    return _BRepTools.Handle_BRepTools_TrsfModification_DownCast(AnObject)
