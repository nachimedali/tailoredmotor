...
def Handle_BRepSweep_SequenceNodeOfSequenceOfShapesOfNumLinearRegularSweep_DownCast(AnObject):
    return _BRepSweep.Handle_BRepSweep_SequenceNodeOfSequenceOfShapesOfNumLinearRegularSweep_DownCast(AnObject)
