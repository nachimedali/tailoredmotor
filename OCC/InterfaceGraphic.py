...
_InterfaceGraphic.TelUnknownArrayType_swigconstant(_InterfaceGraphic)
TelUnknownArrayType = _InterfaceGraphic.TelUnknownArrayType

_InterfaceGraphic.TelPointsArrayType_swigconstant(_InterfaceGraphic)
TelPointsArrayType = _InterfaceGraphic.TelPointsArrayType

_InterfaceGraphic.TelPolylinesArrayType_swigconstant(_InterfaceGraphic)
TelPolylinesArrayType = _InterfaceGraphic.TelPolylinesArrayType

_InterfaceGraphic.TelSegmentsArrayType_swigconstant(_InterfaceGraphic)
TelSegmentsArrayType = _InterfaceGraphic.TelSegmentsArrayType

_InterfaceGraphic.TelPolygonsArrayType_swigconstant(_InterfaceGraphic)
TelPolygonsArrayType = _InterfaceGraphic.TelPolygonsArrayType

_InterfaceGraphic.TelTrianglesArrayType_swigconstant(_InterfaceGraphic)
TelTrianglesArrayType = _InterfaceGraphic.TelTrianglesArrayType

_InterfaceGraphic.TelQuadranglesArrayType_swigconstant(_InterfaceGraphic)
TelQuadranglesArrayType = _InterfaceGraphic.TelQuadranglesArrayType

_InterfaceGraphic.TelTriangleStripsArrayType_swigconstant(_InterfaceGraphic)
TelTriangleStripsArrayType = _InterfaceGraphic.TelTriangleStripsArrayType

_InterfaceGraphic.TelQuadrangleStripsArrayType_swigconstant(_InterfaceGraphic)
TelQuadrangleStripsArrayType = _InterfaceGraphic.TelQuadrangleStripsArrayType

_InterfaceGraphic.TelTriangleFansArrayType_swigconstant(_InterfaceGraphic)
TelTriangleFansArrayType = _InterfaceGraphic.TelTriangleFansArrayType

_InterfaceGraphic.TelCullNone_swigconstant(_InterfaceGraphic)
TelCullNone = _InterfaceGraphic.TelCullNone

_InterfaceGraphic.TelCullFront_swigconstant(_InterfaceGraphic)
TelCullFront = _InterfaceGraphic.TelCullFront

_InterfaceGraphic.TelCullBack_swigconstant(_InterfaceGraphic)
