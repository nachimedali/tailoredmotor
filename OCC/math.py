...
_math.math_OK_swigconstant(_math)
math_OK = _math.math_OK

_math.math_TooManyIterations_swigconstant(_math)
math_TooManyIterations = _math.math_TooManyIterations

_math.math_FunctionError_swigconstant(_math)
math_FunctionError = _math.math_FunctionError

_math.math_DirectionSearchError_swigconstant(_math)
math_DirectionSearchError = _math.math_DirectionSearchError

_math.math_NotBracketed_swigconstant(_math)
