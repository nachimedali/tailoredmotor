...
_BSplCLib.BSplCLib_NonUniform_swigconstant(_BSplCLib)
BSplCLib_NonUniform = _BSplCLib.BSplCLib_NonUniform

_BSplCLib.BSplCLib_Uniform_swigconstant(_BSplCLib)
BSplCLib_Uniform = _BSplCLib.BSplCLib_Uniform

_BSplCLib.BSplCLib_NonConstant_swigconstant(_BSplCLib)
BSplCLib_NonConstant = _BSplCLib.BSplCLib_NonConstant

_BSplCLib.BSplCLib_Constant_swigconstant(_BSplCLib)
BSplCLib_Constant = _BSplCLib.BSplCLib_Constant

_BSplCLib.BSplCLib_QuasiConstant_swigconstant(_BSplCLib)
