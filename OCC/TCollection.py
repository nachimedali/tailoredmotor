...
_TCollection.TCollection_Left_swigconstant(_TCollection)
TCollection_Left = _TCollection.TCollection_Left

_TCollection.TCollection_Right_swigconstant(_TCollection)
...
class TCollection_AVLBaseNode(OCC.MMgt.MMgt_TShared):
    ...
    def SetCount(self, value):
        ...
        return _TCollection.TCollection_AVLBaseNode_SetCount(self, value)
...
def Handle_TCollection_AVLBaseNode_DownCast(AnObject):
    return _TCollection.Handle_TCollection_AVLBaseNode_DownCast(AnObject)
...
def Handle_TCollection_HAsciiString_DownCast(AnObject):
...
def Handle_TCollection_HExtendedString_DownCast(AnObject):
...
def Handle_TCollection_MapNode_DownCast(AnObject):
...
def Handle_TCollection_SeqNode_DownCast(AnObject):
