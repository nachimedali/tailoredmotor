...
_gp.gp_EulerAngles_swigconstant(_gp)
gp_EulerAngles = _gp.gp_EulerAngles

_gp.gp_YawPitchRoll_swigconstant(_gp)
gp_YawPitchRoll = _gp.gp_YawPitchRoll

_gp.gp_Extrinsic_XYZ_swigconstant(_gp)
gp_Extrinsic_XYZ = _gp.gp_Extrinsic_XYZ

_gp.gp_Extrinsic_XZY_swigconstant(_gp)
gp_Extrinsic_XZY = _gp.gp_Extrinsic_XZY

_gp.gp_Extrinsic_YZX_swigconstant(_gp)
gp_Extrinsic_YZX = _gp.gp_Extrinsic_YZX

_gp.gp_Extrinsic_YXZ_swigconstant(_gp)
gp_Extrinsic_YXZ = _gp.gp_Extrinsic_YXZ

_gp.gp_Extrinsic_ZXY_swigconstant(_gp)
gp_Extrinsic_ZXY = _gp.gp_Extrinsic_ZXY

_gp.gp_Extrinsic_ZYX_swigconstant(_gp)
gp_Extrinsic_ZYX = _gp.gp_Extrinsic_ZYX

_gp.gp_Intrinsic_XYZ_swigconstant(_gp)
gp_Intrinsic_XYZ = _gp.gp_Intrinsic_XYZ

_gp.gp_Intrinsic_XZY_swigconstant(_gp)
gp_Intrinsic_XZY = _gp.gp_Intrinsic_XZY

_gp.gp_Intrinsic_YZX_swigconstant(_gp)
gp_Intrinsic_YZX = _gp.gp_Intrinsic_YZX

_gp.gp_Intrinsic_YXZ_swigconstant(_gp)
gp_Intrinsic_YXZ = _gp.gp_Intrinsic_YXZ

_gp.gp_Intrinsic_ZXY_swigconstant(_gp)
gp_Intrinsic_ZXY = _gp.gp_Intrinsic_ZXY

_gp.gp_Intrinsic_ZYX_swigconstant(_gp)
gp_Intrinsic_ZYX = _gp.gp_Intrinsic_ZYX

_gp.gp_Extrinsic_XYX_swigconstant(_gp)
gp_Extrinsic_XYX = _gp.gp_Extrinsic_XYX

_gp.gp_Extrinsic_XZX_swigconstant(_gp)
gp_Extrinsic_XZX = _gp.gp_Extrinsic_XZX

_gp.gp_Extrinsic_YZY_swigconstant(_gp)
gp_Extrinsic_YZY = _gp.gp_Extrinsic_YZY

_gp.gp_Extrinsic_YXY_swigconstant(_gp)
gp_Extrinsic_YXY = _gp.gp_Extrinsic_YXY

_gp.gp_Extrinsic_ZYZ_swigconstant(_gp)
gp_Extrinsic_ZYZ = _gp.gp_Extrinsic_ZYZ

_gp.gp_Extrinsic_ZXZ_swigconstant(_gp)
gp_Extrinsic_ZXZ = _gp.gp_Extrinsic_ZXZ

_gp.gp_Intrinsic_XYX_swigconstant(_gp)
gp_Intrinsic_XYX = _gp.gp_Intrinsic_XYX

_gp.gp_Intrinsic_XZX_swigconstant(_gp)
gp_Intrinsic_XZX = _gp.gp_Intrinsic_XZX

_gp.gp_Intrinsic_YZY_swigconstant(_gp)
gp_Intrinsic_YZY = _gp.gp_Intrinsic_YZY

_gp.gp_Intrinsic_YXY_swigconstant(_gp)
gp_Intrinsic_YXY = _gp.gp_Intrinsic_YXY

_gp.gp_Intrinsic_ZXZ_swigconstant(_gp)
gp_Intrinsic_ZXZ = _gp.gp_Intrinsic_ZXZ

_gp.gp_Intrinsic_ZYZ_swigconstant(_gp)
gp_Intrinsic_ZYZ = _gp.gp_Intrinsic_ZYZ

_gp.gp_Identity_swigconstant(_gp)
gp_Identity = _gp.gp_Identity

_gp.gp_Rotation_swigconstant(_gp)
gp_Rotation = _gp.gp_Rotation

_gp.gp_Translation_swigconstant(_gp)
gp_Translation = _gp.gp_Translation

_gp.gp_PntMirror_swigconstant(_gp)
gp_PntMirror = _gp.gp_PntMirror

_gp.gp_Ax1Mirror_swigconstant(_gp)
gp_Ax1Mirror = _gp.gp_Ax1Mirror

_gp.gp_Ax2Mirror_swigconstant(_gp)
gp_Ax2Mirror = _gp.gp_Ax2Mirror

_gp.gp_Scale_swigconstant(_gp)
gp_Scale = _gp.gp_Scale

_gp.gp_CompoundTrsf_swigconstant(_gp)
gp_CompoundTrsf = _gp.gp_CompoundTrsf

_gp.gp_Other_swigconstant(_gp)
