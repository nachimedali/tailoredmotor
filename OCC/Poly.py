...
def Handle_Poly_HArray1OfTriangle_DownCast(AnObject):
    return _Poly.Handle_Poly_HArray1OfTriangle_DownCast(AnObject)
...
def Handle_Poly_Polygon2D_DownCast(AnObject):
    return _Poly.Handle_Poly_Polygon2D_DownCast(AnObject)
...
def Handle_Poly_Polygon3D_DownCast(AnObject):
    return _Poly.Handle_Poly_Polygon3D_DownCast(AnObject)
...
def Handle_Poly_PolygonOnTriangulation_DownCast(AnObject):
    return _Poly.Handle_Poly_PolygonOnTriangulation_DownCast(AnObject)
...
def Handle_Poly_Triangulation_DownCast(AnObject):
    return _Poly.Handle_Poly_Triangulation_DownCast(AnObject)
