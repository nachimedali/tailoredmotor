...
_GeomLib.GeomLib_NoError_swigconstant(_GeomLib)
GeomLib_NoError = _GeomLib.GeomLib_NoError

_GeomLib.GeomLib_NotEnoughtPoints_swigconstant(_GeomLib)
GeomLib_NotEnoughtPoints = _GeomLib.GeomLib_NotEnoughtPoints

_GeomLib.GeomLib_DegreeSmallerThan3_swigconstant(_GeomLib)
GeomLib_DegreeSmallerThan3 = _GeomLib.GeomLib_DegreeSmallerThan3

_GeomLib.GeomLib_InversionProblem_swigconstant(_GeomLib)
