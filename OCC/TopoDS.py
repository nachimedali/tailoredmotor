...
def Handle_TopoDS_HShape_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_HShape_DownCast(AnObject)
...
def Handle_TopoDS_ListNodeOfListOfShape_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_ListNodeOfListOfShape_DownCast(AnObject)
...
def Handle_TopoDS_TShape_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TShape_DownCast(AnObject)
...
def Handle_TopoDS_TCompSolid_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TCompSolid_DownCast(AnObject)
...
def Handle_TopoDS_TCompound_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TCompound_DownCast(AnObject)
...
def Handle_TopoDS_TEdge_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TEdge_DownCast(AnObject)
...
def Handle_TopoDS_TFace_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TFace_DownCast(AnObject)
...
def Handle_TopoDS_TShell_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TShell_DownCast(AnObject)
...
def Handle_TopoDS_TSolid_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TSolid_DownCast(AnObject)
...
def Handle_TopoDS_TVertex_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TVertex_DownCast(AnObject)
...
def Handle_TopoDS_TWire_DownCast(AnObject):
    return _TopoDS.Handle_TopoDS_TWire_DownCast(AnObject)
