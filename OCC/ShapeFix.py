...
def Handle_ShapeFix_DataMapNodeOfDataMapOfShapeBox2d_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_DataMapNodeOfDataMapOfShapeBox2d_DownCast(AnObject)
...
def Handle_ShapeFix_Edge_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Edge_DownCast(AnObject)
...
def Handle_ShapeFix_EdgeProjAux_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_EdgeProjAux_DownCast(AnObject)
...
def Handle_ShapeFix_Root_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Root_DownCast(AnObject)
...
def Handle_ShapeFix_SequenceNodeOfSequenceOfWireSegment_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_SequenceNodeOfSequenceOfWireSegment_DownCast(AnObject)
...
def Handle_ShapeFix_ComposeShell_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_ComposeShell_DownCast(AnObject)
...
def Handle_ShapeFix_Face_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Face_DownCast(AnObject)
...
def Handle_ShapeFix_FixSmallFace_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_FixSmallFace_DownCast(AnObject)
...
def Handle_ShapeFix_Shape_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Shape_DownCast(AnObject)
...
def Handle_ShapeFix_Shell_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Shell_DownCast(AnObject)
...
def Handle_ShapeFix_Solid_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Solid_DownCast(AnObject)
...
def Handle_ShapeFix_SplitCommonVertex_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_SplitCommonVertex_DownCast(AnObject)
...
def Handle_ShapeFix_Wire_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Wire_DownCast(AnObject)
...
def Handle_ShapeFix_Wireframe_DownCast(AnObject):
    return _ShapeFix.Handle_ShapeFix_Wireframe_DownCast(AnObject)
